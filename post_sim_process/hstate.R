...
#--- Combine states ---#
state_20 <- rbind(state_S5_R5_20,state_S5_R5_20b,
...
#---Combine states ---#
state_40 <- rbind(state_S5_R5_40,state_S5_R5_40b,
...
#--- Combine states ---#
state_60 <- rbind(state_S5_R5_60,state_S5_R5_60b,
...
state_truth_20 <- rbind(state_truth_S5_R5_20,state_truth_S5_R5_20b,
...
#--- Combine state_truths ---#
state_truth_40 <- rbind(state_truth_S5_R5_40,state_truth_S5_R5_40b,
...
#--- Combine state_truths ---#
state_truth_60 <- rbind(state_truth_S5_R5_60,state_truth_S5_R5_60b,
...
#--- Combine bias_states ---#
bias_state_20 <- rbind(bias_state_S5_R5_20,bias_state_S5_R5_20b,
...
#--- Combine bias_states ---#
bias_state_40 <- rbind(bias_state_S5_R5_40,bias_state_S5_R5_40b,
...
#--- Combine bias_states ---#
bias_state_60 <- rbind(bias_state_S5_R5_60,bias_state_S5_R5_60b,
...
#--- Combine CI_states ---#
CI_state_20 <- rbind(CI_state_S5_R5_20,CI_state_S5_R5_20b,
...
#--- Combine CI_states ---#
CI_state_40 <- rbind(CI_state_S5_R5_40,CI_state_S5_R5_40b,
...
#--- Combine CI_states ---#
CI_state_60 <- rbind(CI_state_S5_R5_60,CI_state_S5_R5_60b,
...
#--- Combine params ---#
param_20 <- rbind(param_S5_R5_20,param_S5_R5_20b,
...
#--- Combine params ---#
param_40 <- rbind(param_S5_R5_40,param_S5_R5_40b,
...
#--- Combine params ---#
param_60 <- rbind(param_S5_R5_60,param_S5_R5_60b,
...
#--- Combine bias_params ---#
bias_param_20 <- rbind(bias_param_S5_R5_20,bias_param_S5_R5_20b,
...
#--- Combine bias_params ---#
bias_param_40 <- rbind(bias_param_S5_R5_40,bias_param_S5_R5_40b,
...
#--- Combine bias_params ---#
bias_param_60 <- rbind(bias_param_S5_R5_60,bias_param_S5_R5_60b,
...
#--- Combine CI_params ---#
CI_param_20 <- rbind(CI_param_S5_R5_20,CI_param_S5_R5_20b,
...
#--- Combine CI_params ---#
CI_param_40 <- rbind(CI_param_S5_R5_40,CI_param_S5_R5_40b,
...
#--- Combine CI_params ---#
CI_param_60 <- rbind(CI_param_S5_R5_60,CI_param_S5_R5_60b,
...
param_summary_20 <- rbind(param_summary_S5_R5_20,param_summary_S5_R5_20b,
...
#--- Combine param_summary ---#
param_summary_40 <- rbind(param_summary_S5_R5_40,param_summary_S5_R5_40b,
...
#--- Combine param_summary ---#
param_summary_60 <- rbind(param_summary_S5_R5_60,param_summary_S5_R5_60b,
...
#--- Combine dists ---#
dist_20 <- rbind(dist_S5_R5_20,dist_S5_R5_20b,
...
#--- Combine dists ---#
dist_40 <- rbind(dist_S5_R5_40,dist_S5_R5_40b,
...
#--- Combine dists ---#
dist_60 <- rbind(dist_S5_R5_60,dist_S5_R5_60b,
...
#--- Combine dists ---#
sites_20 <- rbind(sites_S5_R5_20,sites_S5_R5_20b,
...
#--- Combine dists ---#
sites_40 <- rbind(sites_S5_R5_40,sites_S5_R5_40b,
...
#--- Combine dists ---#
sites_60 <- rbind(sites_S5_R5_60,sites_S5_R5_60b,
...
VOI_suppress_20 <- rbind(VOI_suppress_20_S5_R5, VOI_suppress_20_S75_R5,
...
VOI_suppress_40 <- rbind(VOI_suppress_40_S5_R5, VOI_suppress_40_S75_R5,
...
VOI_suppress_60 <- rbind(VOI_suppress_60_S5_R5, VOI_suppress_60_S75_R5,
...
VOI_contain_20 <- rbind(VOI_contain_20_S5_R5, VOI_contain_20_S75_R5,
...
VOI_contain_40<- rbind(VOI_contain_40_S5_R5, VOI_contain_40_S75_R5,
...
VOI_contain_60<- rbind(VOI_contain_60_S5_R5, VOI_contain_60_S75_R5,
