...
state_S75_R75_40b$location <- 'hsd'
...
state_truth_S5_R5_20$location <- 'hsd'
...
state_truth_S5_R5_20b$location <- 'hsd'
...
state_truth_S5_R75_20$location <- 'hsd'
...
state_truth_S5_R75_20b$location <- 'hsd'
...
state_truth_S75_R5_20$location <- 'hsd'
...
state_truth_S75_R5_20b$location <- 'hsd'
...
state_truth_S75_R75_20$location <- 'hsd'
...
state_truth_S75_R75_20b$location <- 'hsd'
...
state_truth_S5_R5_40$location <- 'hsd'
...
state_truth_S5_R5_40b$location <- 'hsd'
...
state_truth_S5_R75_40$location <- 'hsd'
...
state_truth_S5_R75_40b$location <- 'hsd'
...
state_truth_S75_R5_40$location <- 'hsd'
...
state_truth_S75_R5_40b$location <- 'hsd'
...
state_truth_S75_R75_40$location <- 'hsd'
...
state_truth_S75_R75_40b$location <- 'hsd'
...
state_truth_S5_R5_60$location <- 'hsd'
...
state_truth_S5_R5_60b$location <- 'hsd'
...
state_truth_S5_R75_60$location <- 'hsd'
...
state_truth_S5_R75_60b$location <- 'hsd'
...
state_truth_S75_R5_60$location <- 'hsd'
...
state_truth_S75_R5_60b$location <- 'hsd'
...
state_truth_S75_R75_60$location <- 'hsd'
...
state_truth_S75_R75_60b$location <- 'hsd'
...
bias_state_S5_R5_20$location <- 'hsd'
...
bias_state_S5_R5_20b$location <- 'hsd'
...
bias_state_S5_R75_20$location <- 'hsd'
...
bias_state_S5_R75_20b$location <- 'hsd'
...
bias_state_S75_R5_20$location <- 'hsd'
...
bias_state_S75_R5_20b$location <- 'hsd'
...
bias_state_S75_R75_20$location <- 'hsd'
...
bias_state_S75_R75_20b$location <- 'hsd'
...
bias_state_S5_R5_40$location <- 'hsd'
...
bias_state_S5_R5_40b$location <- 'hsd'
...
bias_state_S5_R75_40$location <- 'hsd'
...
bias_state_S5_R75_40b$location <- 'hsd'
...
bias_state_S75_R5_40$location <- 'hsd'
...
bias_state_S75_R5_40b$location <- 'hsd'
...
bias_state_S75_R75_40$location <- 'hsd'
...
bias_state_S75_R75_40b$location <- 'hsd'
...
bias_state_S5_R5_60$location <- 'hsd'
...
bias_state_S5_R5_60b$location <- 'hsd'
...
bias_state_S5_R75_60$location <- 'hsd'
...
bias_state_S5_R75_60b$location <- 'hsd'
...
bias_state_S75_R5_60$location <- 'hsd'
...
bias_state_S75_R5_60b$location <- 'hsd'
...
bias_state_S75_R75_60$location <- 'hsd'
...
bias_state_S75_R75_60b$location <- 'hsd'
...
CI_state_S5_R5_20$location <- 'hsd'
...
CI_state_S5_R5_20b$location <- 'hsd'
...
CI_state_S5_R75_20$location <- 'hsd'
...
CI_state_S5_R75_20b$location <- 'hsd'
...
CI_state_S75_R5_20$location <- 'hsd'
...
CI_state_S75_R5_20b$location <- 'hsd'
...
CI_state_S75_R75_20$location <- 'hsd'
...
CI_state_S75_R75_20b$location <- 'hsd'
...
CI_state_S5_R5_40$location <- 'hsd'
...
CI_state_S5_R5_40b$location <- 'hsd'
...
CI_state_S5_R75_40$location <- 'hsd'
...
CI_state_S5_R75_40b$location <- 'hsd'
...
CI_state_S75_R5_40$location <- 'hsd'
...
CI_state_S75_R5_40b$location <- 'hsd'
...
CI_state_S75_R75_40$location <- 'hsd'
...
CI_state_S75_R75_40b$location <- 'hsd'
...
CI_state_S5_R5_60$location <- 'hsd'
...
CI_state_S5_R5_60b$location <- 'hsd'
...
CI_state_S5_R75_60$location <- 'hsd'
...
CI_state_S5_R75_60b$location <- 'hsd'
...
CI_state_S75_R5_60$location <- 'hsd'
...
CI_state_S75_R5_60b$location <- 'hsd'
...
CI_state_S75_R75_60$location <- 'hsd'
...
CI_state_S75_R75_60b$location <- 'hsd'
...
param_S75_R75_20b$location <- 'hsd'
...
param_S75_R75_40b$location <- 'hsd'
...
param_S75_R75_60b$location <- 'hsd'
...
bias_param_S5_R5_20$location <- 'hsd'
...
bias_param_S5_R5_20b$location <- 'hsd'
...
bias_param_S5_R75_20$location <- 'hsd'
...
bias_param_S5_R75_20b$location <- 'hsd'
...
bias_param_S75_R5_20$location <- 'hsd'
...
bias_param_S75_R5_20b$location <- 'hsd'
...
bias_param_S75_R75_20$location <- 'hsd'
...
bias_param_S75_R75_20b$location <- 'hsd'
...
bias_param_S5_R5_40$location <- 'hsd'
...
bias_param_S5_R5_40b$location <- 'hsd'
...
bias_param_S5_R75_40$location <- 'hsd'
...
bias_param_S5_R75_40b$location <- 'hsd'
...
bias_param_S75_R5_40$location <- 'hsd'
...
bias_param_S75_R5_40b$location <- 'hsd'
...
bias_param_S75_R75_40$location <- 'hsd'
...
bias_param_S75_R75_40b$location <- 'hsd'
...
bias_param_S5_R5_60$location <- 'hsd'
...
bias_param_S5_R5_60b$location <- 'hsd'
...
bias_param_S5_R75_60$location <- 'hsd'
...
bias_param_S5_R75_60b$location <- 'hsd'
...
bias_param_S75_R5_60$location <- 'hsd'
...
bias_param_S75_R5_60b$location <- 'hsd'
...
bias_param_S75_R75_60$location <- 'hsd'
...
bias_param_S75_R75_60b$location <- 'hsd'
...
CI_param_S5_R5_20$location <- 'hsd'
...
CI_param_S5_R5_20b$location <- 'hsd'
...
CI_param_S5_R75_20$location <- 'hsd'
...
CI_param_S5_R75_20b$location <- 'hsd'
...
CI_param_S75_R5_20$location <- 'hsd'
...
CI_param_S75_R5_20b$location <- 'hsd'
...
CI_param_S75_R75_20$location <- 'hsd'
...
CI_param_S75_R75_20b$location <- 'hsd'
...
CI_param_S5_R5_40$location <- 'hsd'
...
CI_param_S5_R5_40b$location <- 'hsd'
...
CI_param_S5_R75_40$location <- 'hsd'
...
CI_param_S5_R75_40b$location <- 'hsd'
...
CI_param_S75_R5_40$location <- 'hsd'
...
CI_param_S75_R5_40b$location <- 'hsd'
...
CI_param_S75_R75_40$location <- 'hsd'
...
CI_param_S75_R75_40b$location <- 'hsd'
...
CI_param_S5_R5_60$location <- 'hsd'
...
CI_param_S5_R5_60b$location <- 'hsd'
...
CI_param_S5_R75_60$location <- 'hsd'
...
CI_param_S5_R75_60b$location <- 'hsd'
...
CI_param_S75_R5_60$location <- 'hsd'
...
CI_param_S75_R5_60b$location <- 'hsd'
...
CI_param_S75_R75_60$location <- 'hsd'
...
CI_param_S75_R75_60b$location <- 'hsd'
...
param_summary_S5_R5_20$location <- 'hsd'
...
param_summary_S5_R5_20b$location <- 'hsd'
...
param_summary_S5_R75_20$location <- 'hsd'
...
param_summary_S5_R75_20b$location <- 'hsd'
...
param_summary_S75_R5_20$location <- 'hsd'
...
param_summary_S75_R5_20b$location <- 'hsd'
...
param_summary_S75_R75_20$location <- 'hsd'
...
param_summary_S75_R75_20b$location <- 'hsd'
...
param_summary_S5_R5_40$location <- 'hsd'
...
param_summary_S5_R5_40b$location <- 'hsd'
...
param_summary_S5_R75_40$location <- 'hsd'
...
param_summary_S5_R75_40b$location <- 'hsd'
...
param_summary_S75_R5_40$location <- 'hsd'
...
param_summary_S75_R5_40b$location <- 'hsd'
...
param_summary_S75_R75_40$location <- 'hsd'
...
param_summary_S75_R75_40b$location <- 'hsd'
...
param_summary_S5_R5_60$location <- 'hsd'
...
param_summary_S5_R5_60b$location <- 'hsd'
...
param_summary_S5_R75_60$location <- 'hsd'
...
param_summary_S5_R75_60b$location <- 'hsd'
...
param_summary_S75_R5_60$location <- 'hsd'
...
param_summary_S75_R5_60b$location <- 'hsd'
...
param_summary_S75_R75_60$location <- 'hsd'
...
param_summary_S75_R75_60b$location <- 'hsd'
...
sites_S75_R75_20b$location <- 'hsd'
...
sites_S75_R75_40b$location <- 'hsd'
...
sites_S75_R75_60b$location <- 'hsd'
...
state_truth_fin <- state_truth %>% filter(week == 5 & year == 10)
file_name = paste(path, 'states_fin_truth.csv',sep = '/')
fwrite(state_truth_fin,file_name)
