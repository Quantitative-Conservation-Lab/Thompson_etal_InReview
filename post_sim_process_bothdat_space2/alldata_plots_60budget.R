...
finstate_truth <- rbind(state_truth_S5_R75_60, state_truth_S5_R75_60b,
...
finstate_truth <- finstate_truth %>% filter(Budget == 60)
...
fininv_truth <- rbind(state_truth_S5_R75_60, state_truth_S5_R75_60b,
                      epistate_truth_S5_R75_60, epistate_truth_S5_R75_60b)
...
bias_state <- rbind(hsb_biasstate_S5_R75_60, hsb_biasstate_S5_R75_60b,
...
bias_state  <- bias_state  %>% filter(Budget == 60)
...
bias_param <- rbind(hsb_biasparam_S5_R75_60, hsb_biasparam_S5_R75_60b,
...
budget60_bias_param_p <- bias_param_p %>% 
  filter(Budget == 60) %>% 
  group_by(loc2, data) %>%
  summarise(mean_c = mean(rel.bias))

budget60_bias_param_p
