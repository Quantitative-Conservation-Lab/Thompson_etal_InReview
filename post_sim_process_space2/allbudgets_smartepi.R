...
state_S5_R75_20$location <- 'hstatebins'
...
state_S5_R75_40$location <- 'hstatebins'
...
state_S5_R75_60$location <- 'hstatebins'
...
state_hstatebins <- rbind(state_20, state_40, state_60)

##### linear #####
#-- Budget = 20 --#
#--- S25_R5_20 ---#
path <- 'D:\\Chapter3\\results-space2\\linear\\S25_R5_20'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R5_20 <- fread(file_name)
state_S25_R5_20 <- data.frame(state_S25_R5_20)[-1]
...
path <- 'D:\\Chapter3\\results-space2\\linear\\S25_R5_20_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R5_20b <- fread(file_name)
state_S25_R5_20b <- data.frame(state_S25_R5_20b)[-1]
...
#--- S25_R75_20 ---#
path <- 'D:\\Chapter3\\results-space2\\linear\\S25_R75_20'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R75_20 <- fread(file_name)
state_S25_R75_20 <- data.frame(state_S25_R75_20)[-1]
...
path <- 'D:\\Chapter3\\results-space2\\linear\\S25_R75_20_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R75_20b <- fread(file_name)
state_S25_R75_20b <- data.frame(state_S25_R75_20b)[-1]
...
#--- S5_R5_20 ---#
path <- 'D:\\Chapter3\\results-space2\\linear\\S5_R5_20'
file_name = paste(path, 'states.csv',sep = '/')
state_S5_R5_20 <- fread(file_name)
state_S5_R5_20 <- data.frame(state_S5_R5_20)[-1]
...
path <- 'D:\\Chapter3\\results-space2\\linear\\S5_R5_20_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S5_R5_20b <- fread(file_name)
state_S5_R5_20b <- data.frame(state_S5_R5_20b)[-1]
...
#--- S75_R5_20 ---#
path <- 'D:\\Chapter3\\results-space2\\linear\\S75_R5_20'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R5_20 <- fread(file_name)
state_S75_R5_20 <- data.frame(state_S75_R5_20)[-1]
...
path <- 'D:\\Chapter3\\results-space2\\linear\\S75_R5_20_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R5_20b <- fread(file_name)
state_S75_R5_20b <- data.frame(state_S75_R5_20b)[-1]
...
#--- S75_R75_20 ---#
path <- 'D:\\Chapter3\\results-space2\\linear\\S75_R75_20'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R75_20 <- fread(file_name)
state_S75_R75_20 <- data.frame(state_S75_R75_20)[-1]
...
path <- 'D:\\Chapter3\\results-space2\\linear\\S75_R75_20_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R75_20b <- fread(file_name)
state_S75_R75_20b <- data.frame(state_S75_R75_20b)[-1]
...
#-- Budget = 40 --#
#--- S25_R5_40 ---#
path <- 'D:\\Chapter3\\results-space2\\linear\\S25_R5_40'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R5_40 <- fread(file_name)
state_S25_R5_40 <- data.frame(state_S25_R5_40)[-1]
...
path <- 'D:\\Chapter3\\results-space2\\linear\\S25_R5_40_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R5_40b <- fread(file_name)
state_S25_R5_40b <- data.frame(state_S25_R5_40b)[-1]
...
#--- S25_R75_40 ---#
path <- 'D:\\Chapter3\\results-space2\\linear\\S25_R75_40'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R75_40 <- fread(file_name)
state_S25_R75_40 <- data.frame(state_S25_R75_40)[-1]
...
path <- 'D:\\Chapter3\\results-space2\\linear\\S25_R75_40_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R75_40b <- fread(file_name)
state_S25_R75_40b <- data.frame(state_S25_R75_40b)[-1]
...
#--- S5_R5_40 ---#
path <- 'D:\\Chapter3\\results-space2\\linear\\S5_R5_40'
file_name = paste(path, 'states.csv',sep = '/')
state_S5_R5_40 <- fread(file_name)
state_S5_R5_40 <- data.frame(state_S5_R5_40)[-1]
...
path <- 'D:\\Chapter3\\results-space2\\linear\\S5_R5_40_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S5_R5_40b <- fread(file_name)
state_S5_R5_40b <- data.frame(state_S5_R5_40b)[-1]
...
#--- S75_R5_40 ---#
path <- 'D:\\Chapter3\\results-space2\\linear\\S75_R5_40'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R5_40 <- fread(file_name)
state_S75_R5_40 <- data.frame(state_S75_R5_40)[-1]
...
path <- 'D:\\Chapter3\\results-space2\\linear\\S75_R5_40_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R5_40b <- fread(file_name)
state_S75_R5_40b <- data.frame(state_S75_R5_40b)[-1]
...
#--- S75_R75_40 ---#
path <- 'D:\\Chapter3\\results-space2\\linear\\S75_R75_40'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R75_40 <- fread(file_name)
state_S75_R75_40 <- data.frame(state_S75_R75_40)[-1]
...
path <- 'D:\\Chapter3\\results-space2\\linear\\S75_R75_40_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R75_40b <- fread(file_name)
state_S75_R75_40b <- data.frame(state_S75_R75_40b)[-1]
...
#-- Budget = 60 --#
#--- S25_R5_60 ---#
path <- 'D:\\Chapter3\\results-space2\\linear\\S25_R5_60'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R5_60 <- fread(file_name)
state_S25_R5_60 <- data.frame(state_S25_R5_60)[-1]
...
path <- 'D:\\Chapter3\\results-space2\\linear\\S25_R5_60_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R5_60b <- fread(file_name)
state_S25_R5_60b <- data.frame(state_S25_R5_60b)[-1]
...
#--- S25_R75_60 ---#
path <- 'D:\\Chapter3\\results-space2\\linear\\S25_R75_60'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R75_60 <- fread(file_name)
state_S25_R75_60 <- data.frame(state_S25_R75_60)[-1]
...
path <- 'D:\\Chapter3\\results-space2\\linear\\S25_R75_60_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R75_60b <- fread(file_name)
state_S25_R75_60b <- data.frame(state_S25_R75_60b)[-1]
...
#--- S5_R5_60 ---#
path <- 'D:\\Chapter3\\results-space2\\linear\\S5_R5_60'
file_name = paste(path, 'states.csv',sep = '/')
state_S5_R5_60 <- fread(file_name)
state_S5_R5_60 <- data.frame(state_S5_R5_60)[-1]
...
path <- 'D:\\Chapter3\\results-space2\\linear\\S5_R5_60_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S5_R5_60b <- fread(file_name)
state_S5_R5_60b <- data.frame(state_S5_R5_60b)[-1]
...
#--- S75_R5_60 ---#
path <- 'D:\\Chapter3\\results-space2\\linear\\S75_R5_60'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R5_60 <- fread(file_name)
state_S75_R5_60 <- data.frame(state_S75_R5_60)[-1]
...
path <- 'D:\\Chapter3\\results-space2\\linear\\S75_R5_60_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R5_60b <- fread(file_name)
state_S75_R5_60b <- data.frame(state_S75_R5_60b)[-1]
...
#--- S75_R75_60 ---#
path <- 'D:\\Chapter3\\results-space2\\linear\\S75_R75_60'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R75_60 <- fread(file_name)
state_S75_R75_60 <- data.frame(state_S75_R75_60)[-1]
...
path <- 'D:\\Chapter3\\results-space2\\linear\\S75_R75_60_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R75_60b <- fread(file_name)
state_S75_R75_60b <- data.frame(state_S75_R75_60b)[-1]
...
state_linear <- rbind(state_20, state_40, state_60)

##### smartepicenter #####
#-- Budget = 20 --#
#--- S25_R5_20 ---#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R5_20'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R5_20 <- fread(file_name)
state_S25_R5_20 <- data.frame(state_S25_R5_20)[-1]

state_S25_R5_20$location <- 'smartepicenter'
state_S25_R5_20$detection <- 0.25
state_S25_R5_20$eradication <- 0.5
state_S25_R5_20$budget <- 20

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R5_20_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R5_20b <- fread(file_name)
state_S25_R5_20b <- data.frame(state_S25_R5_20b)[-1]

state_S25_R5_20b$location <- 'smartepicenter'
state_S25_R5_20b$detection <- 0.25
state_S25_R5_20b$eradication <- 0.5
state_S25_R5_20b$budget <- 20

#--- S25_R75_20 ---#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R75_20'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R75_20 <- fread(file_name)
state_S25_R75_20 <- data.frame(state_S25_R75_20)[-1]

state_S25_R75_20$location <- 'smartepicenter'
state_S25_R75_20$detection <- 0.25
state_S25_R75_20$eradication <- 0.75
state_S25_R75_20$budget <- 20

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R75_20_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R75_20b <- fread(file_name)
state_S25_R75_20b <- data.frame(state_S25_R75_20b)[-1]

state_S25_R75_20b$location <- 'smartepicenter'
state_S25_R75_20b$detection <- 0.25
state_S25_R75_20b$eradication <- 0.75
state_S25_R75_20b$budget <- 20

#--- S5_R5_20 ---#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R5_20'
file_name = paste(path, 'states.csv',sep = '/')
state_S5_R5_20 <- fread(file_name)
state_S5_R5_20 <- data.frame(state_S5_R5_20)[-1]

state_S5_R5_20$location <- 'smartepicenter'
state_S5_R5_20$detection <- 0.5
state_S5_R5_20$eradication <- 0.5
state_S5_R5_20$budget <- 20

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R5_20_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S5_R5_20b <- fread(file_name)
state_S5_R5_20b <- data.frame(state_S5_R5_20b)[-1]

state_S5_R5_20b$location <- 'smartepicenter'
state_S5_R5_20b$detection <- 0.5
state_S5_R5_20b$eradication <- 0.5
state_S5_R5_20b$budget <- 20
...
#--- S75_R5_20 ---#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R5_20'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R5_20 <- fread(file_name)
state_S75_R5_20 <- data.frame(state_S75_R5_20)[-1]

state_S75_R5_20$location <- 'smartepicenter'
state_S75_R5_20$detection <- 0.75
state_S75_R5_20$eradication <- 0.5
state_S75_R5_20$budget <- 20

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R5_20_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R5_20b <- fread(file_name)
state_S75_R5_20b <- data.frame(state_S75_R5_20b)[-1]

state_S75_R5_20b$location <- 'smartepicenter'
state_S75_R5_20b$detection <- 0.75
state_S75_R5_20b$eradication <- 0.5
state_S75_R5_20b$budget <- 20

#--- S75_R75_20 ---#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R75_20'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R75_20 <- fread(file_name)
state_S75_R75_20 <- data.frame(state_S75_R75_20)[-1]

state_S75_R75_20$location <- 'smartepicenter'
state_S75_R75_20$detection <- 0.75
state_S75_R75_20$eradication <- 0.75
state_S75_R75_20$budget <- 20

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R75_20_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R75_20b <- fread(file_name)
state_S75_R75_20b <- data.frame(state_S75_R75_20b)[-1]

state_S75_R75_20b$location <- 'smartepicenter'
state_S75_R75_20b$detection <- 0.75
state_S75_R75_20b$eradication <- 0.75
state_S75_R75_20b$budget <- 20
...
#-- Budget = 40 --#
#--- S25_R5_40 ---#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R5_40'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R5_40 <- fread(file_name)
state_S25_R5_40 <- data.frame(state_S25_R5_40)[-1]

state_S25_R5_40$location <- 'smartepicenter'
state_S25_R5_40$detection <- 0.25
state_S25_R5_40$eradication <- 0.5
state_S25_R5_40$budget <- 40

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R5_40_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R5_40b <- fread(file_name)
state_S25_R5_40b <- data.frame(state_S25_R5_40b)[-1]

state_S25_R5_40b$location <- 'smartepicenter'
state_S25_R5_40b$detection <- 0.25
state_S25_R5_40b$eradication <- 0.5
state_S25_R5_40b$budget <- 40

#--- S25_R75_40 ---#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R75_40'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R75_40 <- fread(file_name)
state_S25_R75_40 <- data.frame(state_S25_R75_40)[-1]

state_S25_R75_40$location <- 'smartepicenter'
state_S25_R75_40$detection <- 0.25
state_S25_R75_40$eradication <- 0.75
state_S25_R75_40$budget <- 40

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R75_40_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R75_40b <- fread(file_name)
state_S25_R75_40b <- data.frame(state_S25_R75_40b)[-1]

state_S25_R75_40b$location <- 'smartepicenter'
state_S25_R75_40b$detection <- 0.25
state_S25_R75_40b$eradication <- 0.75
state_S25_R75_40b$budget <- 40

#--- S5_R5_40 ---#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R5_40'
file_name = paste(path, 'states.csv',sep = '/')
state_S5_R5_40 <- fread(file_name)
state_S5_R5_40 <- data.frame(state_S5_R5_40)[-1]

state_S5_R5_40$location <- 'smartepicenter'
state_S5_R5_40$detection <- 0.5
state_S5_R5_40$eradication <- 0.5
state_S5_R5_40$budget <- 40

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R5_40_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S5_R5_40b <- fread(file_name)
state_S5_R5_40b <- data.frame(state_S5_R5_40b)[-1]

state_S5_R5_40b$location <- 'smartepicenter'
state_S5_R5_40b$detection <- 0.5
state_S5_R5_40b$eradication <- 0.5
state_S5_R5_40b$budget <- 40
...
#--- S75_R5_40 ---#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R5_40'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R5_40 <- fread(file_name)
state_S75_R5_40 <- data.frame(state_S75_R5_40)[-1]

state_S75_R5_40$location <- 'smartepicenter'
state_S75_R5_40$detection <- 0.75
state_S75_R5_40$eradication <- 0.5
state_S75_R5_40$budget <- 40

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R5_40_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R5_40b <- fread(file_name)
state_S75_R5_40b <- data.frame(state_S75_R5_40b)[-1]

state_S75_R5_40b$location <- 'smartepicenter'
state_S75_R5_40b$detection <- 0.75
state_S75_R5_40b$eradication <- 0.5
state_S75_R5_40b$budget <- 40

#--- S75_R75_40 ---#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R75_40'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R75_40 <- fread(file_name)
state_S75_R75_40 <- data.frame(state_S75_R75_40)[-1]

state_S75_R75_40$location <- 'smartepicenter'
state_S75_R75_40$detection <- 0.75
state_S75_R75_40$eradication <- 0.75
state_S75_R75_40$budget <- 40

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R75_40_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R75_40b <- fread(file_name)
state_S75_R75_40b <- data.frame(state_S75_R75_40b)[-1]

state_S75_R75_40b$location <- 'smartepicenter'
state_S75_R75_40b$detection <- 0.75
state_S75_R75_40b$eradication <- 0.75
state_S75_R75_40b$budget <- 40
...
#-- Budget = 60 --#
#--- S25_R5_60 ---#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R5_60'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R5_60 <- fread(file_name)
state_S25_R5_60 <- data.frame(state_S25_R5_60)[-1]

state_S25_R5_60$location <- 'smartepicenter'
state_S25_R5_60$detection <- 0.25
state_S25_R5_60$eradication <- 0.5
state_S25_R5_60$budget <- 60

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R5_60_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R5_60b <- fread(file_name)
state_S25_R5_60b <- data.frame(state_S25_R5_60b)[-1]

state_S25_R5_60b$location <- 'smartepicenter'
state_S25_R5_60b$detection <- 0.25
state_S25_R5_60b$eradication <- 0.5
state_S25_R5_60b$budget <- 60

#--- S25_R75_60 ---#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R75_60'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R75_60 <- fread(file_name)
state_S25_R75_60 <- data.frame(state_S25_R75_60)[-1]

state_S25_R75_60$location <- 'smartepicenter'
state_S25_R75_60$detection <- 0.25
state_S25_R75_60$eradication <- 0.75
state_S25_R75_60$budget <- 60

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R75_60_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S25_R75_60b <- fread(file_name)
state_S25_R75_60b <- data.frame(state_S25_R75_60b)[-1]

state_S25_R75_60b$location <- 'smartepicenter'
state_S25_R75_60b$detection <- 0.25
state_S25_R75_60b$eradication <- 0.75
state_S25_R75_60b$budget <- 60

#--- S5_R5_60 ---#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R5_60'
file_name = paste(path, 'states.csv',sep = '/')
state_S5_R5_60 <- fread(file_name)
state_S5_R5_60 <- data.frame(state_S5_R5_60)[-1]

state_S5_R5_60$location <- 'smartepicenter'
state_S5_R5_60$detection <- 0.5
state_S5_R5_60$eradication <- 0.5
state_S5_R5_60$budget <- 60

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R5_60_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S5_R5_60b <- fread(file_name)
state_S5_R5_60b <- data.frame(state_S5_R5_60b)[-1]

state_S5_R5_60b$location <- 'smartepicenter'
state_S5_R5_60b$detection <- 0.5
state_S5_R5_60b$eradication <- 0.5
state_S5_R5_60b$budget <- 60
...
#--- S75_R5_60 ---#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R5_60'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R5_60 <- fread(file_name)
state_S75_R5_60 <- data.frame(state_S75_R5_60)[-1]

state_S75_R5_60$location <- 'smartepicenter'
state_S75_R5_60$detection <- 0.75
state_S75_R5_60$eradication <- 0.5
state_S75_R5_60$budget <- 60

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R5_60_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R5_60b <- fread(file_name)
state_S75_R5_60b <- data.frame(state_S75_R5_60b)[-1]

state_S75_R5_60b$location <- 'smartepicenter'
state_S75_R5_60b$detection <- 0.75
state_S75_R5_60b$eradication <- 0.5
state_S75_R5_60b$budget <- 60

#--- S75_R75_60 ---#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R75_60'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R75_60 <- fread(file_name)
state_S75_R75_60 <- data.frame(state_S75_R75_60)[-1]

state_S75_R75_60$location <- 'smartepicenter'
state_S75_R75_60$detection <- 0.75
state_S75_R75_60$eradication <- 0.75
state_S75_R75_60$budget <- 60

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R75_60_b'
file_name = paste(path, 'states.csv',sep = '/')
state_S75_R75_60b <- fread(file_name)
state_S75_R75_60b <- data.frame(state_S75_R75_60b)[-1]

state_S75_R75_60b$location <- 'smartepicenter'
state_S75_R75_60b$detection <- 0.75
state_S75_R75_60b$eradication <- 0.75
state_S75_R75_60b$budget <- 60
...
state_smartepicenter <- rbind(state_20, state_40, state_60)

#### Combine ####
state <- rbind(state_hstatebins, state_linear, state_smartepicenter)
...
state_truth_S25_R5_20$location <- 'smartepicenter'
state_truth_S25_R5_20$detection <- 0.25
state_truth_S25_R5_20$eradication <- 0.5
state_truth_S25_R5_20$budget <- 20
...
state_truth_S25_R5_20b$location <- 'smartepicenter'
state_truth_S25_R5_20b$detection <- 0.25
state_truth_S25_R5_20b$eradication <- 0.5
state_truth_S25_R5_20b$budget <- 20
...
state_truth_S25_R75_20$location <- 'smartepicenter'
state_truth_S25_R75_20$detection <- 0.25
state_truth_S25_R75_20$eradication <- 0.75
state_truth_S25_R75_20$budget <- 20
...
state_truth_S25_R75_20b$location <- 'smartepicenter'
state_truth_S25_R75_20b$detection <- 0.25
state_truth_S25_R75_20b$eradication <- 0.75
state_truth_S25_R75_20b$budget <- 20
...
state_truth_S5_R5_20$location <- 'smartepicenter'
state_truth_S5_R5_20$detection <- 0.5
state_truth_S5_R5_20$eradication <- 0.5
state_truth_S5_R5_20$budget <- 20
...
state_truth_S5_R5_20b$location <- 'smartepicenter'
state_truth_S5_R5_20b$detection <- 0.5
state_truth_S5_R5_20b$eradication <- 0.5
state_truth_S5_R5_20b$budget <- 20
...
state_truth_S5_R75_20$location <- 'smartepicenter'
state_truth_S5_R75_20$detection <- 0.5
state_truth_S5_R75_20$eradication <- 0.75
state_truth_S5_R75_20$budget <- 20
...
state_truth_S5_R75_20b$location <- 'smartepicenter'
state_truth_S5_R75_20b$detection <- 0.5
state_truth_S5_R75_20b$eradication <- 0.75
state_truth_S5_R75_20b$budget <- 20
...
state_truth_S75_R5_20$location <- 'smartepicenter'
state_truth_S75_R5_20$detection <- 0.75
state_truth_S75_R5_20$eradication <- 0.5
state_truth_S75_R5_20$budget <- 20
...
state_truth_S75_R5_20b$location <- 'smartepicenter'
state_truth_S75_R5_20b$detection <- 0.75
state_truth_S75_R5_20b$eradication <- 0.5
state_truth_S75_R5_20b$budget <- 20
...
state_truth_S75_R75_20$location <- 'smartepicenter'
state_truth_S75_R75_20$detection <- 0.75
state_truth_S75_R75_20$eradication <- 0.75
state_truth_S75_R75_20$budget <- 20
...
state_truth_S75_R75_20b$location <- 'smartepicenter'
state_truth_S75_R75_20b$detection <- 0.75
state_truth_S75_R75_20b$eradication <- 0.75
state_truth_S75_R75_20b$budget <- 20
...
state_truth_S25_R5_40$location <- 'smartepicenter'
state_truth_S25_R5_40$detection <- 0.25
state_truth_S25_R5_40$eradication <- 0.5
state_truth_S25_R5_40$budget <- 40
...
state_truth_S25_R5_40b$location <- 'smartepicenter'
state_truth_S25_R5_40b$detection <- 0.25
state_truth_S25_R5_40b$eradication <- 0.5
state_truth_S25_R5_40b$budget <- 40
...
state_truth_S25_R75_40$location <- 'smartepicenter'
state_truth_S25_R75_40$detection <- 0.25
state_truth_S25_R75_40$eradication <- 0.75
state_truth_S25_R75_40$budget <- 40
...
state_truth_S25_R75_40b$location <- 'smartepicenter'
state_truth_S25_R75_40b$detection <- 0.25
state_truth_S25_R75_40b$eradication <- 0.75
state_truth_S25_R75_40b$budget <- 40
...
state_truth_S5_R5_40$location <- 'smartepicenter'
state_truth_S5_R5_40$detection <- 0.5
state_truth_S5_R5_40$eradication <- 0.5
state_truth_S5_R5_40$budget <- 40
...
state_truth_S5_R5_40b$location <- 'smartepicenter'
state_truth_S5_R5_40b$detection <- 0.5
state_truth_S5_R5_40b$eradication <- 0.5
state_truth_S5_R5_40b$budget <- 40
...
state_truth_S75_R5_40$location <- 'smartepicenter'
state_truth_S75_R5_40$detection <- 0.75
state_truth_S75_R5_40$eradication <- 0.5
state_truth_S75_R5_40$budget <- 40
...
state_truth_S75_R5_40b$location <- 'smartepicenter'
state_truth_S75_R5_40b$detection <- 0.75
state_truth_S75_R5_40b$eradication <- 0.5
state_truth_S75_R5_40b$budget <- 40
...
state_truth_S75_R75_40$location <- 'smartepicenter'
state_truth_S75_R75_40$detection <- 0.75
state_truth_S75_R75_40$eradication <- 0.75
state_truth_S75_R75_40$budget <- 40
...
state_truth_S75_R75_40b$location <- 'smartepicenter'
state_truth_S75_R75_40b$detection <- 0.75
state_truth_S75_R75_40b$eradication <- 0.75
state_truth_S75_R75_40b$budget <- 40
...
state_truth_S25_R5_60$location <- 'smartepicenter'
state_truth_S25_R5_60$detection <- 0.25
state_truth_S25_R5_60$eradication <- 0.5
state_truth_S25_R5_60$budget <- 60
...
state_truth_S25_R5_60b$location <- 'smartepicenter'
state_truth_S25_R5_60b$detection <- 0.25
state_truth_S25_R5_60b$eradication <- 0.5
state_truth_S25_R5_60b$budget <- 60
...
state_truth_S25_R75_60$location <- 'smartepicenter'
state_truth_S25_R75_60$detection <- 0.25
state_truth_S25_R75_60$eradication <- 0.75
state_truth_S25_R75_60$budget <- 60
...
state_truth_S25_R75_60b$location <- 'smartepicenter'
state_truth_S25_R75_60b$detection <- 0.25
state_truth_S25_R75_60b$eradication <- 0.75
state_truth_S25_R75_60b$budget <- 60
...
state_truth_S5_R5_60$location <- 'smartepicenter'
state_truth_S5_R5_60$detection <- 0.5
state_truth_S5_R5_60$eradication <- 0.5
state_truth_S5_R5_60$budget <- 60
...
state_truth_S5_R5_60b$location <- 'smartepicenter'
state_truth_S5_R5_60b$detection <- 0.5
state_truth_S5_R5_60b$eradication <- 0.5
state_truth_S5_R5_60b$budget <- 60
...
state_truth_S5_R75_60$location <- 'smartepicenter'
state_truth_S5_R75_60$detection <- 0.5
state_truth_S5_R75_60$eradication <- 0.75
state_truth_S5_R75_60$budget <- 60
...
state_truth_S5_R75_60b$location <- 'smartepicenter'
state_truth_S5_R75_60b$detection <- 0.5
state_truth_S5_R75_60b$eradication <- 0.75
state_truth_S5_R75_60b$budget <- 60
...
state_truth_S75_R5_60$location <- 'smartepicenter'
state_truth_S75_R5_60$detection <- 0.75
state_truth_S75_R5_60$eradication <- 0.5
state_truth_S75_R5_60$budget <- 60
...
state_truth_S75_R5_60b$location <- 'smartepicenter'
state_truth_S75_R5_60b$detection <- 0.75
state_truth_S75_R5_60b$eradication <- 0.5
state_truth_S75_R5_60b$budget <- 60
...
state_truth_S75_R75_60$location <- 'smartepicenter'
state_truth_S75_R75_60$detection <- 0.75
state_truth_S75_R75_60$eradication <- 0.75
state_truth_S75_R75_60$budget <- 60
...
state_truth_S75_R75_60b$location <- 'smartepicenter'
state_truth_S75_R75_60b$detection <- 0.75
state_truth_S75_R75_60b$eradication <- 0.75
state_truth_S75_R75_60b$budget <- 60
...
state_truth_smartepicenter <- rbind(state_truth_20, state_truth_40, state_truth_60)

#### Combine ####
state_truth <- rbind(state_truth_hstatebins, state_truth_linear, state_truth_smartepicenter)
...
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R5_20'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S25_R5_20 <- fread(file_name)
smartepicenter_biasstate_S25_R5_20 <- data.frame(smartepicenter_biasstate_S25_R5_20)[-1]

smartepicenter_biasstate_S25_R5_20$location <- 'smartepicenter'
smartepicenter_biasstate_S25_R5_20$detection <- 0.25
smartepicenter_biasstate_S25_R5_20$eradication <- 0.5
smartepicenter_biasstate_S25_R5_20$budget <- 20

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R5_20_b'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S25_R5_20b <- fread(file_name)
smartepicenter_biasstate_S25_R5_20b <- data.frame(smartepicenter_biasstate_S25_R5_20b)[-1]

smartepicenter_biasstate_S25_R5_20b$location <- 'smartepicenter'
smartepicenter_biasstate_S25_R5_20b$detection <- 0.25
smartepicenter_biasstate_S25_R5_20b$eradication <- 0.5
smartepicenter_biasstate_S25_R5_20b$budget <- 20
#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R75_20'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S25_R75_20 <- fread(file_name)
smartepicenter_biasstate_S25_R75_20 <- data.frame(smartepicenter_biasstate_S25_R75_20)[-1]

smartepicenter_biasstate_S25_R75_20$location <- 'smartepicenter'
smartepicenter_biasstate_S25_R75_20$detection <- 0.25
smartepicenter_biasstate_S25_R75_20$eradication <- 0.75
smartepicenter_biasstate_S25_R75_20$budget <- 20

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R75_20_b'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S25_R75_20b <- fread(file_name)
smartepicenter_biasstate_S25_R75_20b <- data.frame(smartepicenter_biasstate_S25_R75_20b)[-1]

smartepicenter_biasstate_S25_R75_20b$location <- 'smartepicenter'
smartepicenter_biasstate_S25_R75_20b$detection <- 0.25
smartepicenter_biasstate_S25_R75_20b$eradication <- 0.75
smartepicenter_biasstate_S25_R75_20b$budget <- 20

##
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R5_20'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S5_R5_20 <- fread(file_name)
smartepicenter_biasstate_S5_R5_20 <- data.frame(smartepicenter_biasstate_S5_R5_20)[-1]

smartepicenter_biasstate_S5_R5_20$location <- 'smartepicenter'
smartepicenter_biasstate_S5_R5_20$detection <- 0.5
smartepicenter_biasstate_S5_R5_20$eradication <- 0.5
smartepicenter_biasstate_S5_R5_20$budget <- 20

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R5_20_b'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S5_R5_20b <- fread(file_name)
smartepicenter_biasstate_S5_R5_20b <- data.frame(smartepicenter_biasstate_S5_R5_20b)[-1]

smartepicenter_biasstate_S5_R5_20b$location <- 'smartepicenter'
smartepicenter_biasstate_S5_R5_20b$detection <- 0.5
smartepicenter_biasstate_S5_R5_20b$eradication <- 0.5
smartepicenter_biasstate_S5_R5_20b$budget <- 20
#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R75_20'
file_name = paste(path, 'bias_states.csv',sep = '/')
...
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R5_20'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S75_R5_20 <- fread(file_name)
smartepicenter_biasstate_S75_R5_20 <- data.frame(smartepicenter_biasstate_S75_R5_20)[-1]

smartepicenter_biasstate_S75_R5_20$location <- 'smartepicenter'
smartepicenter_biasstate_S75_R5_20$detection <- 0.75
smartepicenter_biasstate_S75_R5_20$eradication <- 0.5
smartepicenter_biasstate_S75_R5_20$budget <- 20

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R5_20_b'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S75_R5_20b <- fread(file_name)
smartepicenter_biasstate_S75_R5_20b <- data.frame(smartepicenter_biasstate_S75_R5_20b)[-1]

smartepicenter_biasstate_S75_R5_20b$location <- 'smartepicenter'
smartepicenter_biasstate_S75_R5_20b$detection <- 0.75
smartepicenter_biasstate_S75_R5_20b$eradication <- 0.5
smartepicenter_biasstate_S75_R5_20b$budget <- 20
#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R75_20'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S75_R75_20 <- fread(file_name)
smartepicenter_biasstate_S75_R75_20 <- data.frame(smartepicenter_biasstate_S75_R75_20)[-1]

smartepicenter_biasstate_S75_R75_20$location <- 'smartepicenter'
smartepicenter_biasstate_S75_R75_20$detection <- 0.75
smartepicenter_biasstate_S75_R75_20$eradication <- 0.75
smartepicenter_biasstate_S75_R75_20$budget <- 20

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R75_20_b'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S75_R75_20b <- fread(file_name)
smartepicenter_biasstate_S75_R75_20b <- data.frame(smartepicenter_biasstate_S75_R75_20b)[-1]

smartepicenter_biasstate_S75_R75_20b$location <- 'smartepicenter'
smartepicenter_biasstate_S75_R75_20b$detection <- 0.75
smartepicenter_biasstate_S75_R75_20b$eradication <- 0.75
smartepicenter_biasstate_S75_R75_20b$budget <- 20

#----- smartepicenter -----#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R5_40'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S25_R5_40 <- fread(file_name)
smartepicenter_biasstate_S25_R5_40 <- data.frame(smartepicenter_biasstate_S25_R5_40)[-1]

smartepicenter_biasstate_S25_R5_40$location <- 'smartepicenter'
smartepicenter_biasstate_S25_R5_40$detection <- 0.25
smartepicenter_biasstate_S25_R5_40$eradication <- 0.5
smartepicenter_biasstate_S25_R5_40$budget <- 40

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R5_40_b'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S25_R5_40b <- fread(file_name)
smartepicenter_biasstate_S25_R5_40b <- data.frame(smartepicenter_biasstate_S25_R5_40b)[-1]

smartepicenter_biasstate_S25_R5_40b$location <- 'smartepicenter'
smartepicenter_biasstate_S25_R5_40b$detection <- 0.25
smartepicenter_biasstate_S25_R5_40b$eradication <- 0.5
smartepicenter_biasstate_S25_R5_40b$budget <- 40
#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R75_40'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S25_R75_40 <- fread(file_name)
smartepicenter_biasstate_S25_R75_40 <- data.frame(smartepicenter_biasstate_S25_R75_40)[-1]

smartepicenter_biasstate_S25_R75_40$location <- 'smartepicenter'
smartepicenter_biasstate_S25_R75_40$detection <- 0.25
smartepicenter_biasstate_S25_R75_40$eradication <- 0.75
smartepicenter_biasstate_S25_R75_40$budget <- 40

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R75_40_b'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S25_R75_40b <- fread(file_name)
smartepicenter_biasstate_S25_R75_40b <- data.frame(smartepicenter_biasstate_S25_R75_40b)[-1]

smartepicenter_biasstate_S25_R75_40b$location <- 'smartepicenter'
smartepicenter_biasstate_S25_R75_40b$detection <- 0.25
smartepicenter_biasstate_S25_R75_40b$eradication <- 0.75
smartepicenter_biasstate_S25_R75_40b$budget <- 40

##
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R5_40'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S5_R5_40 <- fread(file_name)
smartepicenter_biasstate_S5_R5_40 <- data.frame(smartepicenter_biasstate_S5_R5_40)[-1]

smartepicenter_biasstate_S5_R5_40$location <- 'smartepicenter'
smartepicenter_biasstate_S5_R5_40$detection <- 0.5
smartepicenter_biasstate_S5_R5_40$eradication <- 0.5
smartepicenter_biasstate_S5_R5_40$budget <- 40

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R5_40_b'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S5_R5_40b <- fread(file_name)
smartepicenter_biasstate_S5_R5_40b <- data.frame(smartepicenter_biasstate_S5_R5_40b)[-1]

smartepicenter_biasstate_S5_R5_40b$location <- 'smartepicenter'
smartepicenter_biasstate_S5_R5_40b$detection <- 0.5
smartepicenter_biasstate_S5_R5_40b$eradication <- 0.5
smartepicenter_biasstate_S5_R5_40b$budget <- 40
#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R75_40'
file_name = paste(path, 'bias_states.csv',sep = '/')
...
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R5_40'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S75_R5_40 <- fread(file_name)
smartepicenter_biasstate_S75_R5_40 <- data.frame(smartepicenter_biasstate_S75_R5_40)[-1]

smartepicenter_biasstate_S75_R5_40$location <- 'smartepicenter'
smartepicenter_biasstate_S75_R5_40$detection <- 0.75
smartepicenter_biasstate_S75_R5_40$eradication <- 0.5
smartepicenter_biasstate_S75_R5_40$budget <- 40

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R5_40_b'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S75_R5_40b <- fread(file_name)
smartepicenter_biasstate_S75_R5_40b <- data.frame(smartepicenter_biasstate_S75_R5_40b)[-1]

smartepicenter_biasstate_S75_R5_40b$location <- 'smartepicenter'
smartepicenter_biasstate_S75_R5_40b$detection <- 0.75
smartepicenter_biasstate_S75_R5_40b$eradication <- 0.5
smartepicenter_biasstate_S75_R5_40b$budget <- 40
#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R75_40'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S75_R75_40 <- fread(file_name)
smartepicenter_biasstate_S75_R75_40 <- data.frame(smartepicenter_biasstate_S75_R75_40)[-1]

smartepicenter_biasstate_S75_R75_40$location <- 'smartepicenter'
smartepicenter_biasstate_S75_R75_40$detection <- 0.75
smartepicenter_biasstate_S75_R75_40$eradication <- 0.75
smartepicenter_biasstate_S75_R75_40$budget <- 40

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R75_40_b'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S75_R75_40b <- fread(file_name)
smartepicenter_biasstate_S75_R75_40b <- data.frame(smartepicenter_biasstate_S75_R75_40b)[-1]

smartepicenter_biasstate_S75_R75_40b$location <- 'smartepicenter'
smartepicenter_biasstate_S75_R75_40b$detection <- 0.75
smartepicenter_biasstate_S75_R75_40b$eradication <- 0.75
smartepicenter_biasstate_S75_R75_40b$budget <- 40


#----- smartepicenter -----#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R5_60'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S25_R5_60 <- fread(file_name)
smartepicenter_biasstate_S25_R5_60 <- data.frame(smartepicenter_biasstate_S25_R5_60)[-1]

smartepicenter_biasstate_S25_R5_60$location <- 'smartepicenter'
smartepicenter_biasstate_S25_R5_60$detection <- 0.25
smartepicenter_biasstate_S25_R5_60$eradication <- 0.5
smartepicenter_biasstate_S25_R5_60$budget <- 60

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R5_60_b'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S25_R5_60b <- fread(file_name)
smartepicenter_biasstate_S25_R5_60b <- data.frame(smartepicenter_biasstate_S25_R5_60b)[-1]

smartepicenter_biasstate_S25_R5_60b$location <- 'smartepicenter'
smartepicenter_biasstate_S25_R5_60b$detection <- 0.25
smartepicenter_biasstate_S25_R5_60b$eradication <- 0.5
smartepicenter_biasstate_S25_R5_60b$budget <- 60
#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R75_60'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S25_R75_60 <- fread(file_name)
smartepicenter_biasstate_S25_R75_60 <- data.frame(smartepicenter_biasstate_S25_R75_60)[-1]

smartepicenter_biasstate_S25_R75_60$location <- 'smartepicenter'
smartepicenter_biasstate_S25_R75_60$detection <- 0.25
smartepicenter_biasstate_S25_R75_60$eradication <- 0.75
smartepicenter_biasstate_S25_R75_60$budget <- 60

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R75_60_b'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S25_R75_60b <- fread(file_name)
smartepicenter_biasstate_S25_R75_60b <- data.frame(smartepicenter_biasstate_S25_R75_60b)[-1]

smartepicenter_biasstate_S25_R75_60b$location <- 'smartepicenter'
smartepicenter_biasstate_S25_R75_60b$detection <- 0.25
smartepicenter_biasstate_S25_R75_60b$eradication <- 0.75
smartepicenter_biasstate_S25_R75_60b$budget <- 60

##
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R5_60'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S5_R5_60 <- fread(file_name)
smartepicenter_biasstate_S5_R5_60 <- data.frame(smartepicenter_biasstate_S5_R5_60)[-1]

smartepicenter_biasstate_S5_R5_60$location <- 'smartepicenter'
smartepicenter_biasstate_S5_R5_60$detection <- 0.5
smartepicenter_biasstate_S5_R5_60$eradication <- 0.5
smartepicenter_biasstate_S5_R5_60$budget <- 60

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R5_60_b'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S5_R5_60b <- fread(file_name)
smartepicenter_biasstate_S5_R5_60b <- data.frame(smartepicenter_biasstate_S5_R5_60b)[-1]

smartepicenter_biasstate_S5_R5_60b$location <- 'smartepicenter'
smartepicenter_biasstate_S5_R5_60b$detection <- 0.5
smartepicenter_biasstate_S5_R5_60b$eradication <- 0.5
smartepicenter_biasstate_S5_R5_60b$budget <- 60
#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R75_60'
file_name = paste(path, 'bias_states.csv',sep = '/')
...
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R5_60'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S75_R5_60 <- fread(file_name)
smartepicenter_biasstate_S75_R5_60 <- data.frame(smartepicenter_biasstate_S75_R5_60)[-1]

smartepicenter_biasstate_S75_R5_60$location <- 'smartepicenter'
smartepicenter_biasstate_S75_R5_60$detection <- 0.75
smartepicenter_biasstate_S75_R5_60$eradication <- 0.5
smartepicenter_biasstate_S75_R5_60$budget <- 60

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R5_60_b'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S75_R5_60b <- fread(file_name)
smartepicenter_biasstate_S75_R5_60b <- data.frame(smartepicenter_biasstate_S75_R5_60b)[-1]

smartepicenter_biasstate_S75_R5_60b$location <- 'smartepicenter'
smartepicenter_biasstate_S75_R5_60b$detection <- 0.75
smartepicenter_biasstate_S75_R5_60b$eradication <- 0.5
smartepicenter_biasstate_S75_R5_60b$budget <- 60
#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R75_60'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S75_R75_60 <- fread(file_name)
smartepicenter_biasstate_S75_R75_60 <- data.frame(smartepicenter_biasstate_S75_R75_60)[-1]

smartepicenter_biasstate_S75_R75_60$location <- 'smartepicenter'
smartepicenter_biasstate_S75_R75_60$detection <- 0.75
smartepicenter_biasstate_S75_R75_60$eradication <- 0.75
smartepicenter_biasstate_S75_R75_60$budget <- 60

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R75_60_b'
file_name = paste(path, 'bias_states.csv',sep = '/')
smartepicenter_biasstate_S75_R75_60b <- fread(file_name)
smartepicenter_biasstate_S75_R75_60b <- data.frame(smartepicenter_biasstate_S75_R75_60b)[-1]

smartepicenter_biasstate_S75_R75_60b$location <- 'smartepicenter'
smartepicenter_biasstate_S75_R75_60b$detection <- 0.75
smartepicenter_biasstate_S75_R75_60b$eradication <- 0.75
smartepicenter_biasstate_S75_R75_60b$budget <- 60
...
bias_state_20 <- rbind(hsb_biasstate_S25_R5_20,hsb_biasstate_S25_R5_20b,
                       ...
                       smartepicenter_biasstate_S25_R5_20,smartepicenter_biasstate_S25_R5_20b,
                       smartepicenter_biasstate_S25_R75_20,smartepicenter_biasstate_S25_R75_20b,
                       smartepicenter_biasstate_S5_R5_20,smartepicenter_biasstate_S5_R5_20b,
                       smartepicenter_biasstate_S5_R75_20,smartepicenter_biasstate_S5_R75_20b,
                       smartepicenter_biasstate_S75_R5_20,smartepicenter_biasstate_S75_R5_20b,
                       smartepicenter_biasstate_S75_R75_20,smartepicenter_biasstate_S75_R75_20b)
...
bias_state_40 <- rbind(hsb_biasstate_S25_R5_40,hsb_biasstate_S25_R5_40b,
                       ...
                       smartepicenter_biasstate_S25_R5_40,smartepicenter_biasstate_S25_R5_40b,
                       smartepicenter_biasstate_S25_R75_40,smartepicenter_biasstate_S25_R75_40b,
                       smartepicenter_biasstate_S5_R5_40,smartepicenter_biasstate_S5_R5_40b,
                       smartepicenter_biasstate_S5_R75_40,smartepicenter_biasstate_S5_R75_40b,
                       smartepicenter_biasstate_S75_R5_40,smartepicenter_biasstate_S75_R5_40b,
                       smartepicenter_biasstate_S75_R75_40,smartepicenter_biasstate_S75_R75_40b)
...
bias_state_60 <- rbind(hsb_biasstate_S25_R5_60,hsb_biasstate_S25_R5_60b,
                       ...
                       smartepicenter_biasstate_S25_R5_60,smartepicenter_biasstate_S25_R5_60b,
                       smartepicenter_biasstate_S25_R75_60,smartepicenter_biasstate_S25_R75_60b,
                       smartepicenter_biasstate_S5_R5_60,smartepicenter_biasstate_S5_R5_60b,
                       smartepicenter_biasstate_S5_R75_60,smartepicenter_biasstate_S5_R75_60b,
                       smartepicenter_biasstate_S75_R5_60,smartepicenter_biasstate_S75_R5_60b,
                       smartepicenter_biasstate_S75_R75_60,smartepicenter_biasstate_S75_R75_60b)
...
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R5_20'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S25_R5_20 <- fread(file_name)
smartepicenter_biasparam_S25_R5_20 <- data.frame(smartepicenter_biasparam_S25_R5_20)[-1]

smartepicenter_biasparam_S25_R5_20$location <- 'smartepicenter'
smartepicenter_biasparam_S25_R5_20$detection <- 0.25
smartepicenter_biasparam_S25_R5_20$eradication <- 0.5
smartepicenter_biasparam_S25_R5_20$budget <- 20

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R5_20_b'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S25_R5_20b <- fread(file_name)
smartepicenter_biasparam_S25_R5_20b <- data.frame(smartepicenter_biasparam_S25_R5_20b)[-1]

smartepicenter_biasparam_S25_R5_20b$location <- 'smartepicenter'
smartepicenter_biasparam_S25_R5_20b$detection <- 0.25
smartepicenter_biasparam_S25_R5_20b$eradication <- 0.5
smartepicenter_biasparam_S25_R5_20b$budget <- 20
#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R75_20'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S25_R75_20 <- fread(file_name)
smartepicenter_biasparam_S25_R75_20 <- data.frame(smartepicenter_biasparam_S25_R75_20)[-1]

smartepicenter_biasparam_S25_R75_20$location <- 'smartepicenter'
smartepicenter_biasparam_S25_R75_20$detection <- 0.25
smartepicenter_biasparam_S25_R75_20$eradication <- 0.75
smartepicenter_biasparam_S25_R75_20$budget <- 20

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R75_20_b'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S25_R75_20b <- fread(file_name)
smartepicenter_biasparam_S25_R75_20b <- data.frame(smartepicenter_biasparam_S25_R75_20b)[-1]

smartepicenter_biasparam_S25_R75_20b$location <- 'smartepicenter'
smartepicenter_biasparam_S25_R75_20b$detection <- 0.25
smartepicenter_biasparam_S25_R75_20b$eradication <- 0.75
smartepicenter_biasparam_S25_R75_20b$budget <- 20

##
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R5_20'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S5_R5_20 <- fread(file_name)
smartepicenter_biasparam_S5_R5_20 <- data.frame(smartepicenter_biasparam_S5_R5_20)[-1]

smartepicenter_biasparam_S5_R5_20$location <- 'smartepicenter'
smartepicenter_biasparam_S5_R5_20$detection <- 0.5
smartepicenter_biasparam_S5_R5_20$eradication <- 0.5
smartepicenter_biasparam_S5_R5_20$budget <- 20

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R5_20_b'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S5_R5_20b <- fread(file_name)
smartepicenter_biasparam_S5_R5_20b <- data.frame(smartepicenter_biasparam_S5_R5_20b)[-1]

smartepicenter_biasparam_S5_R5_20b$location <- 'smartepicenter'
smartepicenter_biasparam_S5_R5_20b$detection <- 0.5
smartepicenter_biasparam_S5_R5_20b$eradication <- 0.5
smartepicenter_biasparam_S5_R5_20b$budget <- 20
#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R75_20'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S5_R75_20 <- fread(file_name)
smartepicenter_biasparam_S5_R75_20 <- data.frame(smartepicenter_biasparam_S5_R75_20)[-1]

smartepicenter_biasparam_S5_R75_20$location <- 'smartepicenter'
smartepicenter_biasparam_S5_R75_20$detection <- 0.5
smartepicenter_biasparam_S5_R75_20$eradication <- 0.75
smartepicenter_biasparam_S5_R75_20$budget <- 20

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R75_20_b'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S5_R75_20b <- fread(file_name)
smartepicenter_biasparam_S5_R75_20b <- data.frame(smartepicenter_biasparam_S5_R75_20b)[-1]

smartepicenter_biasparam_S5_R75_20b$location <- 'smartepicenter'
smartepicenter_biasparam_S5_R75_20b$detection <- 0.5
smartepicenter_biasparam_S5_R75_20b$eradication <- 0.75
smartepicenter_biasparam_S5_R75_20b$budget <- 20
##
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R5_20'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S75_R5_20 <- fread(file_name)
smartepicenter_biasparam_S75_R5_20 <- data.frame(smartepicenter_biasparam_S75_R5_20)[-1]

smartepicenter_biasparam_S75_R5_20$location <- 'smartepicenter'
smartepicenter_biasparam_S75_R5_20$detection <- 0.75
smartepicenter_biasparam_S75_R5_20$eradication <- 0.5
smartepicenter_biasparam_S75_R5_20$budget <- 20

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R5_20_b'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S75_R5_20b <- fread(file_name)
smartepicenter_biasparam_S75_R5_20b <- data.frame(smartepicenter_biasparam_S75_R5_20b)[-1]

smartepicenter_biasparam_S75_R5_20b$location <- 'smartepicenter'
smartepicenter_biasparam_S75_R5_20b$detection <- 0.75
smartepicenter_biasparam_S75_R5_20b$eradication <- 0.5
smartepicenter_biasparam_S75_R5_20b$budget <- 20
#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R75_20'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S75_R75_20 <- fread(file_name)
smartepicenter_biasparam_S75_R75_20 <- data.frame(smartepicenter_biasparam_S75_R75_20)[-1]

smartepicenter_biasparam_S75_R75_20$location <- 'smartepicenter'
smartepicenter_biasparam_S75_R75_20$detection <- 0.75
smartepicenter_biasparam_S75_R75_20$eradication <- 0.75
smartepicenter_biasparam_S75_R75_20$budget <- 20

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R75_20_b'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S75_R75_20b <- fread(file_name)
smartepicenter_biasparam_S75_R75_20b <- data.frame(smartepicenter_biasparam_S75_R75_20b)[-1]

smartepicenter_biasparam_S75_R75_20b$location <- 'smartepicenter'
smartepicenter_biasparam_S75_R75_20b$detection <- 0.75
smartepicenter_biasparam_S75_R75_20b$eradication <- 0.75
smartepicenter_biasparam_S75_R75_20b$budget <- 20

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R5_40'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S25_R5_40 <- fread(file_name)
smartepicenter_biasparam_S25_R5_40 <- data.frame(smartepicenter_biasparam_S25_R5_40)[-1]

smartepicenter_biasparam_S25_R5_40$location <- 'smartepicenter'
smartepicenter_biasparam_S25_R5_40$detection <- 0.25
smartepicenter_biasparam_S25_R5_40$eradication <- 0.5
smartepicenter_biasparam_S25_R5_40$budget <- 40

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R5_40_b'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S25_R5_40b <- fread(file_name)
smartepicenter_biasparam_S25_R5_40b <- data.frame(smartepicenter_biasparam_S25_R5_40b)[-1]

smartepicenter_biasparam_S25_R5_40b$location <- 'smartepicenter'
smartepicenter_biasparam_S25_R5_40b$detection <- 0.25
smartepicenter_biasparam_S25_R5_40b$eradication <- 0.5
smartepicenter_biasparam_S25_R5_40b$budget <- 40
#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R75_40'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S25_R75_40 <- fread(file_name)
smartepicenter_biasparam_S25_R75_40 <- data.frame(smartepicenter_biasparam_S25_R75_40)[-1]

smartepicenter_biasparam_S25_R75_40$location <- 'smartepicenter'
smartepicenter_biasparam_S25_R75_40$detection <- 0.25
smartepicenter_biasparam_S25_R75_40$eradication <- 0.75
smartepicenter_biasparam_S25_R75_40$budget <- 40

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R75_40_b'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S25_R75_40b <- fread(file_name)
smartepicenter_biasparam_S25_R75_40b <- data.frame(smartepicenter_biasparam_S25_R75_40b)[-1]

smartepicenter_biasparam_S25_R75_40b$location <- 'smartepicenter'
smartepicenter_biasparam_S25_R75_40b$detection <- 0.25
smartepicenter_biasparam_S25_R75_40b$eradication <- 0.75
smartepicenter_biasparam_S25_R75_40b$budget <- 40

##
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R5_40'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S5_R5_40 <- fread(file_name)
smartepicenter_biasparam_S5_R5_40 <- data.frame(smartepicenter_biasparam_S5_R5_40)[-1]

smartepicenter_biasparam_S5_R5_40$location <- 'smartepicenter'
smartepicenter_biasparam_S5_R5_40$detection <- 0.5
smartepicenter_biasparam_S5_R5_40$eradication <- 0.5
smartepicenter_biasparam_S5_R5_40$budget <- 40

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R5_40_b'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S5_R5_40b <- fread(file_name)
smartepicenter_biasparam_S5_R5_40b <- data.frame(smartepicenter_biasparam_S5_R5_40b)[-1]

smartepicenter_biasparam_S5_R5_40b$location <- 'smartepicenter'
smartepicenter_biasparam_S5_R5_40b$detection <- 0.5
smartepicenter_biasparam_S5_R5_40b$eradication <- 0.5
smartepicenter_biasparam_S5_R5_40b$budget <- 40
#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R75_40'
file_name = paste(path, 'bias_params.csv',sep = '/')
...
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R5_40'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S75_R5_40 <- fread(file_name)
smartepicenter_biasparam_S75_R5_40 <- data.frame(smartepicenter_biasparam_S75_R5_40)[-1]

smartepicenter_biasparam_S75_R5_40$location <- 'smartepicenter'
smartepicenter_biasparam_S75_R5_40$detection <- 0.75
smartepicenter_biasparam_S75_R5_40$eradication <- 0.5
smartepicenter_biasparam_S75_R5_40$budget <- 40

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R5_40_b'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S75_R5_40b <- fread(file_name)
smartepicenter_biasparam_S75_R5_40b <- data.frame(smartepicenter_biasparam_S75_R5_40b)[-1]

smartepicenter_biasparam_S75_R5_40b$location <- 'smartepicenter'
smartepicenter_biasparam_S75_R5_40b$detection <- 0.75
smartepicenter_biasparam_S75_R5_40b$eradication <- 0.5
smartepicenter_biasparam_S75_R5_40b$budget <- 40
#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R75_40'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S75_R75_40 <- fread(file_name)
smartepicenter_biasparam_S75_R75_40 <- data.frame(smartepicenter_biasparam_S75_R75_40)[-1]

smartepicenter_biasparam_S75_R75_40$location <- 'smartepicenter'
smartepicenter_biasparam_S75_R75_40$detection <- 0.75
smartepicenter_biasparam_S75_R75_40$eradication <- 0.75
smartepicenter_biasparam_S75_R75_40$budget <- 40

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R75_40_b'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S75_R75_40b <- fread(file_name)
smartepicenter_biasparam_S75_R75_40b <- data.frame(smartepicenter_biasparam_S75_R75_40b)[-1]

smartepicenter_biasparam_S75_R75_40b$location <- 'smartepicenter'
smartepicenter_biasparam_S75_R75_40b$detection <- 0.75
smartepicenter_biasparam_S75_R75_40b$eradication <- 0.75
smartepicenter_biasparam_S75_R75_40b$budget <- 40

#----- smartepicenter -----#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R5_60'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S25_R5_60 <- fread(file_name)
smartepicenter_biasparam_S25_R5_60 <- data.frame(smartepicenter_biasparam_S25_R5_60)[-1]

smartepicenter_biasparam_S25_R5_60$location <- 'smartepicenter'
smartepicenter_biasparam_S25_R5_60$detection <- 0.25
smartepicenter_biasparam_S25_R5_60$eradication <- 0.5
smartepicenter_biasparam_S25_R5_60$budget <- 60

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R5_60_b'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S25_R5_60b <- fread(file_name)
smartepicenter_biasparam_S25_R5_60b <- data.frame(smartepicenter_biasparam_S25_R5_60b)[-1]

smartepicenter_biasparam_S25_R5_60b$location <- 'smartepicenter'
smartepicenter_biasparam_S25_R5_60b$detection <- 0.25
smartepicenter_biasparam_S25_R5_60b$eradication <- 0.5
smartepicenter_biasparam_S25_R5_60b$budget <- 60
#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R75_60'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S25_R75_60 <- fread(file_name)
smartepicenter_biasparam_S25_R75_60 <- data.frame(smartepicenter_biasparam_S25_R75_60)[-1]

smartepicenter_biasparam_S25_R75_60$location <- 'smartepicenter'
smartepicenter_biasparam_S25_R75_60$detection <- 0.25
smartepicenter_biasparam_S25_R75_60$eradication <- 0.75
smartepicenter_biasparam_S25_R75_60$budget <- 60

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S25_R75_60_b'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S25_R75_60b <- fread(file_name)
smartepicenter_biasparam_S25_R75_60b <- data.frame(smartepicenter_biasparam_S25_R75_60b)[-1]

smartepicenter_biasparam_S25_R75_60b$location <- 'smartepicenter'
smartepicenter_biasparam_S25_R75_60b$detection <- 0.25
smartepicenter_biasparam_S25_R75_60b$eradication <- 0.75
smartepicenter_biasparam_S25_R75_60b$budget <- 60

##
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R5_60'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S5_R5_60 <- fread(file_name)
smartepicenter_biasparam_S5_R5_60 <- data.frame(smartepicenter_biasparam_S5_R5_60)[-1]

smartepicenter_biasparam_S5_R5_60$location <- 'smartepicenter'
smartepicenter_biasparam_S5_R5_60$detection <- 0.5
smartepicenter_biasparam_S5_R5_60$eradication <- 0.5
smartepicenter_biasparam_S5_R5_60$budget <- 60

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R5_60_b'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S5_R5_60b <- fread(file_name)
smartepicenter_biasparam_S5_R5_60b <- data.frame(smartepicenter_biasparam_S5_R5_60b)[-1]

smartepicenter_biasparam_S5_R5_60b$location <- 'smartepicenter'
smartepicenter_biasparam_S5_R5_60b$detection <- 0.5
smartepicenter_biasparam_S5_R5_60b$eradication <- 0.5
smartepicenter_biasparam_S5_R5_60b$budget <- 60
#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R75_60'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S5_R75_60 <- fread(file_name)
smartepicenter_biasparam_S5_R75_60 <- data.frame(smartepicenter_biasparam_S5_R75_60)[-1]

smartepicenter_biasparam_S5_R75_60$location <- 'smartepicenter'
smartepicenter_biasparam_S5_R75_60$detection <- 0.5
smartepicenter_biasparam_S5_R75_60$eradication <- 0.75
smartepicenter_biasparam_S5_R75_60$budget <- 60

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S5_R75_60_b'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S5_R75_60b <- fread(file_name)
smartepicenter_biasparam_S5_R75_60b <- data.frame(smartepicenter_biasparam_S5_R75_60b)[-1]

smartepicenter_biasparam_S5_R75_60b$location <- 'smartepicenter'
smartepicenter_biasparam_S5_R75_60b$detection <- 0.5
smartepicenter_biasparam_S5_R75_60b$eradication <- 0.75
smartepicenter_biasparam_S5_R75_60b$budget <- 60
##
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R5_60'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S75_R5_60 <- fread(file_name)
smartepicenter_biasparam_S75_R5_60 <- data.frame(smartepicenter_biasparam_S75_R5_60)[-1]

smartepicenter_biasparam_S75_R5_60$location <- 'smartepicenter'
smartepicenter_biasparam_S75_R5_60$detection <- 0.75
smartepicenter_biasparam_S75_R5_60$eradication <- 0.5
smartepicenter_biasparam_S75_R5_60$budget <- 60

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R5_60_b'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S75_R5_60b <- fread(file_name)
smartepicenter_biasparam_S75_R5_60b <- data.frame(smartepicenter_biasparam_S75_R5_60b)[-1]

smartepicenter_biasparam_S75_R5_60b$location <- 'smartepicenter'
smartepicenter_biasparam_S75_R5_60b$detection <- 0.75
smartepicenter_biasparam_S75_R5_60b$eradication <- 0.5
smartepicenter_biasparam_S75_R5_60b$budget <- 60
#
path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R75_60'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S75_R75_60 <- fread(file_name)
smartepicenter_biasparam_S75_R75_60 <- data.frame(smartepicenter_biasparam_S75_R75_60)[-1]

smartepicenter_biasparam_S75_R75_60$location <- 'smartepicenter'
smartepicenter_biasparam_S75_R75_60$detection <- 0.75
smartepicenter_biasparam_S75_R75_60$eradication <- 0.75
smartepicenter_biasparam_S75_R75_60$budget <- 60

path <- 'D:\\Chapter3\\results-space2\\smartepicenter\\S75_R75_60_b'
file_name = paste(path, 'bias_params.csv',sep = '/')
smartepicenter_biasparam_S75_R75_60b <- fread(file_name)
smartepicenter_biasparam_S75_R75_60b <- data.frame(smartepicenter_biasparam_S75_R75_60b)[-1]

smartepicenter_biasparam_S75_R75_60b$location <- 'smartepicenter'
smartepicenter_biasparam_S75_R75_60b$detection <- 0.75
smartepicenter_biasparam_S75_R75_60b$eradication <- 0.75
smartepicenter_biasparam_S75_R75_60b$budget <- 60
...
bias_param_20 <- rbind(hsb_biasparam_S25_R5_20,hsb_biasparam_S25_R5_20b,
                       ...
                       smartepicenter_biasparam_S25_R5_20,smartepicenter_biasparam_S25_R5_20b,
                       smartepicenter_biasparam_S25_R75_20,smartepicenter_biasparam_S25_R75_20b,
                       smartepicenter_biasparam_S5_R5_20,smartepicenter_biasparam_S5_R5_20b,
                       smartepicenter_biasparam_S5_R75_20,smartepicenter_biasparam_S5_R75_20b,
                       smartepicenter_biasparam_S75_R5_20,smartepicenter_biasparam_S75_R5_20b,
                       smartepicenter_biasparam_S75_R75_20,smartepicenter_biasparam_S75_R75_20b)
...
bias_param_40 <- rbind(hsb_biasparam_S25_R5_40,hsb_biasparam_S25_R5_40b,
                       ...
                       smartepicenter_biasparam_S25_R5_40,smartepicenter_biasparam_S25_R5_40b,
                       smartepicenter_biasparam_S25_R75_40,smartepicenter_biasparam_S25_R75_40b,
                       smartepicenter_biasparam_S5_R5_40,smartepicenter_biasparam_S5_R5_40b,
                       smartepicenter_biasparam_S5_R75_40,smartepicenter_biasparam_S5_R75_40b,
                       smartepicenter_biasparam_S75_R5_40,smartepicenter_biasparam_S75_R5_40b,
                       smartepicenter_biasparam_S75_R75_40,smartepicenter_biasparam_S75_R75_40b)
...
bias_param_60 <- rbind(hsb_biasparam_S25_R5_60,hsb_biasparam_S25_R5_60b,
                       ...
                       smartepicenter_biasparam_S25_R5_60,smartepicenter_biasparam_S25_R5_60b,
                       smartepicenter_biasparam_S25_R75_60,smartepicenter_biasparam_S25_R75_60b,
                       smartepicenter_biasparam_S5_R5_60,smartepicenter_biasparam_S5_R5_60b,
                       smartepicenter_biasparam_S5_R75_60,smartepicenter_biasparam_S5_R75_60b,
                       smartepicenter_biasparam_S75_R5_60,smartepicenter_biasparam_S75_R5_60b,
                       smartepicenter_biasparam_S75_R75_60,smartepicenter_biasparam_S75_R75_60b)
...
sites_S25_R5_20$location <- 'smartepicenter'
sites_S25_R5_20$detection <- 0.25
sites_S25_R5_20$eradication <- 0.5
sites_S25_R5_20$budget <- 20
...
sites_S25_R5_20b$location <- 'smartepicenter'
sites_S25_R5_20b$detection <- 0.25
sites_S25_R5_20b$eradication <- 0.5
sites_S25_R5_20b$budget <- 20
...
sites_S25_R75_20$location <- 'smartepicenter'
sites_S25_R75_20$detection <- 0.25
sites_S25_R75_20$eradication <- 0.75
sites_S25_R75_20$budget <- 20
...
sites_S25_R75_20b$location <- 'smartepicenter'
sites_S25_R75_20b$detection <- 0.25
sites_S25_R75_20b$eradication <- 0.75
sites_S25_R75_20b$budget <- 20
...
sites_S5_R5_20$location <- 'smartepicenter'
sites_S5_R5_20$detection <- 0.5
sites_S5_R5_20$eradication <- 0.5
sites_S5_R5_20$budget <- 20
...
sites_S5_R5_20b$location <- 'smartepicenter'
sites_S5_R5_20b$detection <- 0.5
sites_S5_R5_20b$eradication <- 0.5
sites_S5_R5_20b$budget <- 20
...
sites_S5_R75_20$location <- 'smartepicenter'
sites_S5_R75_20$detection <- 0.5
sites_S5_R75_20$eradication <- 0.75
sites_S5_R75_20$budget <- 20
...
sites_S5_R75_20b$location <- 'smartepicenter'
sites_S5_R75_20b$detection <- 0.5
sites_S5_R75_20b$eradication <- 0.75
sites_S5_R75_20b$budget <- 20
...
sites_S75_R5_20$location <- 'smartepicenter'
sites_S75_R5_20$detection <- 0.75
sites_S75_R5_20$eradication <- 0.5
sites_S75_R5_20$budget <- 20
...
sites_S75_R5_20b$location <- 'smartepicenter'
sites_S75_R5_20b$detection <- 0.75
sites_S75_R5_20b$eradication <- 0.5
sites_S75_R5_20b$budget <- 20
...
sites_S75_R75_20$location <- 'smartepicenter'
sites_S75_R75_20$detection <- 0.75
sites_S75_R75_20$eradication <- 0.75
sites_S75_R75_20$budget <- 20
...
sites_S75_R75_20b$location <- 'smartepicenter'
sites_S75_R75_20b$detection <- 0.75
sites_S75_R75_20b$eradication <- 0.75
sites_S75_R75_20b$budget <- 20
...
sites_S25_R5_40$location <- 'smartepicenter'
sites_S25_R5_40$detection <- 0.25
sites_S25_R5_40$eradication <- 0.5
sites_S25_R5_40$budget <- 40
...
sites_S25_R5_40b$location <- 'smartepicenter'
sites_S25_R5_40b$detection <- 0.25
sites_S25_R5_40b$eradication <- 0.5
sites_S25_R5_40b$budget <- 40
...
sites_S25_R75_40$location <- 'smartepicenter'
sites_S25_R75_40$detection <- 0.25
sites_S25_R75_40$eradication <- 0.75
sites_S25_R75_40$budget <- 40
...
sites_S25_R75_40b$location <- 'smartepicenter'
sites_S25_R75_40b$detection <- 0.25
sites_S25_R75_40b$eradication <- 0.75
sites_S25_R75_40b$budget <- 40
...
sites_S5_R5_40$location <- 'smartepicenter'
sites_S5_R5_40$detection <- 0.5
sites_S5_R5_40$eradication <- 0.5
sites_S5_R5_40$budget <- 40
...
sites_S5_R5_40b$location <- 'smartepicenter'
sites_S5_R5_40b$detection <- 0.5
sites_S5_R5_40b$eradication <- 0.5
sites_S5_R5_40b$budget <- 40
...
sites_S75_R5_40$location <- 'smartepicenter'
sites_S75_R5_40$detection <- 0.75
sites_S75_R5_40$eradication <- 0.5
sites_S75_R5_40$budget <- 40
...
sites_S75_R5_40b$location <- 'smartepicenter'
sites_S75_R5_40b$detection <- 0.75
sites_S75_R5_40b$eradication <- 0.5
sites_S75_R5_40b$budget <- 40
...
sites_S75_R75_40$location <- 'smartepicenter'
sites_S75_R75_40$detection <- 0.75
sites_S75_R75_40$eradication <- 0.75
sites_S75_R75_40$budget <- 40
...
sites_S75_R75_40b$location <- 'smartepicenter'
sites_S75_R75_40b$detection <- 0.75
sites_S75_R75_40b$eradication <- 0.75
sites_S75_R75_40b$budget <- 40
...
sites_S25_R5_60$location <- 'smartepicenter'
sites_S25_R5_60$detection <- 0.25
sites_S25_R5_60$eradication <- 0.5
sites_S25_R5_60$budget <- 60
...
sites_S25_R5_60b$location <- 'smartepicenter'
sites_S25_R5_60b$detection <- 0.25
sites_S25_R5_60b$eradication <- 0.5
sites_S25_R5_60b$budget <- 60
...
sites_S25_R75_60$location <- 'smartepicenter'
sites_S25_R75_60$detection <- 0.25
sites_S25_R75_60$eradication <- 0.75
sites_S25_R75_60$budget <- 60
...
sites_S25_R75_60b$location <- 'smartepicenter'
sites_S25_R75_60b$detection <- 0.25
sites_S25_R75_60b$eradication <- 0.75
sites_S25_R75_60b$budget <- 60
...
sites_S5_R5_60$location <- 'smartepicenter'
sites_S5_R5_60$detection <- 0.5
sites_S5_R5_60$eradication <- 0.5
sites_S5_R5_60$budget <- 60
...
sites_S5_R5_60b$location <- 'smartepicenter'
sites_S5_R5_60b$detection <- 0.5
sites_S5_R5_60b$eradication <- 0.5
sites_S5_R5_60b$budget <- 60
...
sites_S5_R75_60$location <- 'smartepicenter'
sites_S5_R75_60$detection <- 0.5
sites_S5_R75_60$eradication <- 0.75
sites_S5_R75_60$budget <- 60
...
sites_S5_R75_60b$location <- 'smartepicenter'
sites_S5_R75_60b$detection <- 0.5
sites_S5_R75_60b$eradication <- 0.75
sites_S5_R75_60b$budget <- 60
...
sites_S75_R5_60$location <- 'smartepicenter'
sites_S75_R5_60$detection <- 0.75
sites_S75_R5_60$eradication <- 0.5
sites_S75_R5_60$budget <- 60
...
sites_S75_R5_60b$location <- 'smartepicenter'
sites_S75_R5_60b$detection <- 0.75
sites_S75_R5_60b$eradication <- 0.5
sites_S75_R5_60b$budget <- 60
...
sites_S75_R75_60$location <- 'smartepicenter'
sites_S75_R75_60$detection <- 0.75
sites_S75_R75_60$eradication <- 0.75
sites_S75_R75_60$budget <- 60
...
sites_S75_R75_60b$location <- 'smartepicenter'
sites_S75_R75_60b$detection <- 0.75
sites_S75_R75_60b$eradication <- 0.75
sites_S75_R75_60b$budget <- 60
...
dist_S25_R5_20$location <- 'smartepicenter'
dist_S25_R5_20$detection <- 0.25
dist_S25_R5_20$eradication <- 0.5
dist_S25_R5_20$budget <- 20
...
dist_S25_R5_20b$location <- 'smartepicenter'
dist_S25_R5_20b$detection <- 0.25
dist_S25_R5_20b$eradication <- 0.5
dist_S25_R5_20b$budget <- 20
...
dist_S25_R75_20$location <- 'smartepicenter'
dist_S25_R75_20$detection <- 0.25
dist_S25_R75_20$eradication <- 0.75
dist_S25_R75_20$budget <- 20
...
dist_S25_R75_20b$location <- 'smartepicenter'
dist_S25_R75_20b$detection <- 0.25
dist_S25_R75_20b$eradication <- 0.75
dist_S25_R75_20b$budget <- 20
...
dist_S5_R5_20$location <- 'smartepicenter'
dist_S5_R5_20$detection <- 0.5
dist_S5_R5_20$eradication <- 0.5
dist_S5_R5_20$budget <- 20
...
dist_S5_R5_20b$location <- 'smartepicenter'
dist_S5_R5_20b$detection <- 0.5
dist_S5_R5_20b$eradication <- 0.5
dist_S5_R5_20b$budget <- 20
...
dist_S5_R75_20$location <- 'smartepicenter'
dist_S5_R75_20$detection <- 0.5
dist_S5_R75_20$eradication <- 0.75
dist_S5_R75_20$budget <- 20
...
dist_S5_R75_20b$location <- 'smartepicenter'
dist_S5_R75_20b$detection <- 0.5
dist_S5_R75_20b$eradication <- 0.75
dist_S5_R75_20b$budget <- 20
...
dist_S75_R5_20$location <- 'smartepicenter'
dist_S75_R5_20$detection <- 0.75
dist_S75_R5_20$eradication <- 0.5
dist_S75_R5_20$budget <- 20
...
dist_S75_R5_20b$location <- 'smartepicenter'
dist_S75_R5_20b$detection <- 0.75
dist_S75_R5_20b$eradication <- 0.5
dist_S75_R5_20b$budget <- 20
...
dist_S75_R75_20$location <- 'smartepicenter'
dist_S75_R75_20$detection <- 0.75
dist_S75_R75_20$eradication <- 0.75
dist_S75_R75_20$budget <- 20
...
dist_S75_R75_20b$location <- 'smartepicenter'
dist_S75_R75_20b$detection <- 0.75
dist_S75_R75_20b$eradication <- 0.75
dist_S75_R75_20b$budget <- 20
...
dist_S25_R5_40$location <- 'smartepicenter'
dist_S25_R5_40$detection <- 0.25
dist_S25_R5_40$eradication <- 0.5
dist_S25_R5_40$budget <- 40
...
dist_S25_R5_40b$location <- 'smartepicenter'
dist_S25_R5_40b$detection <- 0.25
dist_S25_R5_40b$eradication <- 0.5
dist_S25_R5_40b$budget <- 40
...
dist_S25_R75_40$location <- 'smartepicenter'
dist_S25_R75_40$detection <- 0.25
dist_S25_R75_40$eradication <- 0.75
dist_S25_R75_40$budget <- 40
...
dist_S25_R75_40b$location <- 'smartepicenter'
dist_S25_R75_40b$detection <- 0.25
dist_S25_R75_40b$eradication <- 0.75
dist_S25_R75_40b$budget <- 40
...
dist_S5_R5_40$location <- 'smartepicenter'
dist_S5_R5_40$detection <- 0.5
dist_S5_R5_40$eradication <- 0.5
dist_S5_R5_40$budget <- 40
...
dist_S5_R5_40b$location <- 'smartepicenter'
dist_S5_R5_40b$detection <- 0.5
dist_S5_R5_40b$eradication <- 0.5
dist_S5_R5_40b$budget <- 40
...
dist_S75_R5_40$location <- 'smartepicenter'
dist_S75_R5_40$detection <- 0.75
dist_S75_R5_40$eradication <- 0.5
dist_S75_R5_40$budget <- 40
...
dist_S75_R5_40b$location <- 'smartepicenter'
dist_S75_R5_40b$detection <- 0.75
dist_S75_R5_40b$eradication <- 0.5
dist_S75_R5_40b$budget <- 40
...
dist_S75_R75_40$location <- 'smartepicenter'
dist_S75_R75_40$detection <- 0.75
dist_S75_R75_40$eradication <- 0.75
dist_S75_R75_40$budget <- 40
...
dist_S75_R75_40b$location <- 'smartepicenter'
dist_S75_R75_40b$detection <- 0.75
dist_S75_R75_40b$eradication <- 0.75
dist_S75_R75_40b$budget <- 40
...
dist_S25_R5_60$location <- 'smartepicenter'
dist_S25_R5_60$detection <- 0.25
dist_S25_R5_60$eradication <- 0.5
dist_S25_R5_60$budget <- 60
...
dist_S25_R5_60b$location <- 'smartepicenter'
dist_S25_R5_60b$detection <- 0.25
dist_S25_R5_60b$eradication <- 0.5
dist_S25_R5_60b$budget <- 60
...
dist_S25_R75_60$location <- 'smartepicenter'
dist_S25_R75_60$detection <- 0.25
dist_S25_R75_60$eradication <- 0.75
dist_S25_R75_60$budget <- 60
...
dist_S25_R75_60b$location <- 'smartepicenter'
dist_S25_R75_60b$detection <- 0.25
dist_S25_R75_60b$eradication <- 0.75
dist_S25_R75_60b$budget <- 60
...
dist_S5_R5_60$location <- 'smartepicenter'
dist_S5_R5_60$detection <- 0.5
dist_S5_R5_60$eradication <- 0.5
dist_S5_R5_60$budget <- 60
...
dist_S5_R5_60b$location <- 'smartepicenter'
dist_S5_R5_60b$detection <- 0.5
dist_S5_R5_60b$eradication <- 0.5
dist_S5_R5_60b$budget <- 60
...
dist_S5_R75_60$location <- 'smartepicenter'
dist_S5_R75_60$detection <- 0.5
dist_S5_R75_60$eradication <- 0.75
dist_S5_R75_60$budget <- 60
...
dist_S5_R75_60b$location <- 'smartepicenter'
dist_S5_R75_60b$detection <- 0.5
dist_S5_R75_60b$eradication <- 0.75
dist_S5_R75_60b$budget <- 60
...
dist_S75_R5_60$location <- 'smartepicenter'
dist_S75_R5_60$detection <- 0.75
dist_S75_R5_60$eradication <- 0.5
dist_S75_R5_60$budget <- 60
...
dist_S75_R5_60b$location <- 'smartepicenter'
dist_S75_R5_60b$detection <- 0.75
dist_S75_R5_60b$eradication <- 0.5
dist_S75_R5_60b$budget <- 60
...
dist_S75_R75_60$location <- 'smartepicenter'
dist_S75_R75_60$detection <- 0.75
dist_S75_R75_60$eradication <- 0.75
dist_S75_R75_60$budget <- 60
...
dist_S75_R75_60b$location <- 'smartepicenter'
dist_S75_R75_60b$detection <- 0.75
dist_S75_R75_60b$eradication <- 0.75
dist_S75_R75_60b$budget <- 60
...
param_summary_S25_R5_20$location <- 'hstatebins'
...
param_summary_S25_R5_20b$location <- 'hstatebins'
...
param_summary_S25_R75_20$location <- 'hstatebins'
...
param_summary_S25_R75_20b$location <- 'hstatebins'
...
param_summary_S5_R5_20$location <- 'hstatebins'
...
param_summary_S5_R5_20b$location <- 'hstatebins'
...
param_summary_S5_R75_20$location <- 'hstatebins'
...
param_summary_S5_R75_20b$location <- 'hstatebins'
...
param_summary_S75_R5_20$location <- 'hstatebins'
...
param_summary_S75_R5_20b$location <- 'hstatebins'
...
param_summary_S75_R75_20$location <- 'hstatebins'
...
param_summary_S75_R75_20b$location <- 'hstatebins'
...
param_summary_S25_R5_40$location <- 'hstatebins'
...
param_summary_S25_R5_40b$location <- 'hstatebins'
...
param_summary_S25_R75_40$location <- 'hstatebins'
...
param_summary_S25_R75_40b$location <- 'hstatebins'
...
param_summary_S5_R5_40$location <- 'hstatebins'
...
param_summary_S5_R5_40b$location <- 'hstatebins'
...
param_summary_S5_R75_40$location <- 'hstatebins'
...
param_summary_S5_R75_40b$location <- 'hstatebins'
...
param_summary_S75_R5_40$location <- 'hstatebins'
...
param_summary_S75_R5_40b$location <- 'hstatebins'
...
param_summary_S75_R75_40$location <- 'hstatebins'
...
param_summary_S75_R75_40b$location <- 'hstatebins'
...
param_summary_S25_R5_60$location <- 'hstatebins'
...
param_summary_S25_R5_60b$location <- 'hstatebins'
...
param_summary_S25_R75_60$location <- 'hstatebins'
...
param_summary_S25_R75_60b$location <- 'hstatebins'
...
param_summary_S5_R5_60$location <- 'hstatebins'
...
param_summary_S5_R5_60b$location <- 'hstatebins'
...
param_summary_S5_R75_60$location <- 'hstatebins'
...
param_summary_S5_R75_60b$location <- 'hstatebins'
...
param_summary_S75_R5_60$location <- 'hstatebins'
...
param_summary_S75_R5_60b$location <- 'hstatebins'
...
param_summary_S75_R75_60$location <- 'hstatebins'
...
param_summary_S75_R75_60b$location <- 'hstatebins'
...
param_summary_hstatebins <- rbind(param_summary_20, param_summary_40, param_summary_60)
...
param_summary_linear <- rbind(param_summary_20, param_summary_40, param_summary_60)
...
param_summary_S25_R5_20$location <- 'smartepicenter'
param_summary_S25_R5_20$detection <- 0.25
param_summary_S25_R5_20$eradication <- 0.5
param_summary_S25_R5_20$budget <- 20
...
param_summary_S25_R5_20b$location <- 'smartepicenter'
param_summary_S25_R5_20b$detection <- 0.25
param_summary_S25_R5_20b$eradication <- 0.5
param_summary_S25_R5_20b$budget <- 20
...
param_summary_S25_R75_20$location <- 'smartepicenter'
param_summary_S25_R75_20$detection <- 0.25
param_summary_S25_R75_20$eradication <- 0.75
param_summary_S25_R75_20$budget <- 20
...
param_summary_S25_R75_20b$location <- 'smartepicenter'
param_summary_S25_R75_20b$detection <- 0.25
param_summary_S25_R75_20b$eradication <- 0.75
param_summary_S25_R75_20b$budget <- 20
...
param_summary_S5_R5_20$location <- 'smartepicenter'
param_summary_S5_R5_20$detection <- 0.5
param_summary_S5_R5_20$eradication <- 0.5
param_summary_S5_R5_20$budget <- 20
...
param_summary_S5_R5_20b$location <- 'smartepicenter'
param_summary_S5_R5_20b$detection <- 0.5
param_summary_S5_R5_20b$eradication <- 0.5
param_summary_S5_R5_20b$budget <- 20
...
param_summary_S5_R75_20$location <- 'smartepicenter'
param_summary_S5_R75_20$detection <- 0.5
param_summary_S5_R75_20$eradication <- 0.75
param_summary_S5_R75_20$budget <- 20
...
param_summary_S5_R75_20b$location <- 'smartepicenter'
param_summary_S5_R75_20b$detection <- 0.5
param_summary_S5_R75_20b$eradication <- 0.75
param_summary_S5_R75_20b$budget <- 20
...
param_summary_S75_R5_20$location <- 'smartepicenter'
param_summary_S75_R5_20$detection <- 0.75
param_summary_S75_R5_20$eradication <- 0.5
param_summary_S75_R5_20$budget <- 20
...
param_summary_S75_R5_20b$location <- 'smartepicenter'
param_summary_S75_R5_20b$detection <- 0.75
param_summary_S75_R5_20b$eradication <- 0.5
param_summary_S75_R5_20b$budget <- 20
...
param_summary_S75_R75_20$location <- 'smartepicenter'
param_summary_S75_R75_20$detection <- 0.75
param_summary_S75_R75_20$eradication <- 0.75
param_summary_S75_R75_20$budget <- 20
...
param_summary_S75_R75_20b$location <- 'smartepicenter'
param_summary_S75_R75_20b$detection <- 0.75
param_summary_S75_R75_20b$eradication <- 0.75
param_summary_S75_R75_20b$budget <- 20
...
param_summary_S25_R5_40$location <- 'smartepicenter'
param_summary_S25_R5_40$detection <- 0.25
param_summary_S25_R5_40$eradication <- 0.5
param_summary_S25_R5_40$budget <- 40
...
param_summary_S25_R5_40b$location <- 'smartepicenter'
param_summary_S25_R5_40b$detection <- 0.25
param_summary_S25_R5_40b$eradication <- 0.5
param_summary_S25_R5_40b$budget <- 40
...
param_summary_S25_R75_40$location <- 'smartepicenter'
param_summary_S25_R75_40$detection <- 0.25
param_summary_S25_R75_40$eradication <- 0.75
param_summary_S25_R75_40$budget <- 40
...
param_summary_S25_R75_40b$location <- 'smartepicenter'
param_summary_S25_R75_40b$detection <- 0.25
param_summary_S25_R75_40b$eradication <- 0.75
param_summary_S25_R75_40b$budget <- 40
...
param_summary_S5_R5_40$location <- 'smartepicenter'
param_summary_S5_R5_40$detection <- 0.5
param_summary_S5_R5_40$eradication <- 0.5
param_summary_S5_R5_40$budget <- 40
...
param_summary_S5_R5_40b$location <- 'smartepicenter'
param_summary_S5_R5_40b$detection <- 0.5
param_summary_S5_R5_40b$eradication <- 0.5
param_summary_S5_R5_40b$budget <- 40
...
param_summary_S5_R75_40$location <- 'smartepicenter'
param_summary_S5_R75_40$detection <- 0.5
param_summary_S5_R75_40$eradication <- 0.75
param_summary_S5_R75_40$budget <- 40
...
param_summary_S5_R75_40b$location <- 'smartepicenter'
param_summary_S5_R75_40b$detection <- 0.5
param_summary_S5_R75_40b$eradication <- 0.75
param_summary_S5_R75_40b$budget <- 40
...
param_summary_S75_R5_40$location <- 'smartepicenter'
param_summary_S75_R5_40$detection <- 0.75
param_summary_S75_R5_40$eradication <- 0.5
param_summary_S75_R5_40$budget <- 40
...
param_summary_S75_R5_40b$location <- 'smartepicenter'
param_summary_S75_R5_40b$detection <- 0.75
param_summary_S75_R5_40b$eradication <- 0.5
param_summary_S75_R5_40b$budget <- 40
...
param_summary_S75_R75_40$location <- 'smartepicenter'
param_summary_S75_R75_40$detection <- 0.75
param_summary_S75_R75_40$eradication <- 0.75
param_summary_S75_R75_40$budget <- 40
...
param_summary_S75_R75_40b$location <- 'smartepicenter'
param_summary_S75_R75_40b$detection <- 0.75
param_summary_S75_R75_40b$eradication <- 0.75
param_summary_S75_R75_40b$budget <- 40
...
param_summary_S25_R5_60$location <- 'smartepicenter'
param_summary_S25_R5_60$detection <- 0.25
param_summary_S25_R5_60$eradication <- 0.5
param_summary_S25_R5_60$budget <- 60
...
param_summary_S25_R5_60b$location <- 'smartepicenter'
param_summary_S25_R5_60b$detection <- 0.25
param_summary_S25_R5_60b$eradication <- 0.5
param_summary_S25_R5_60b$budget <- 60
...
param_summary_S25_R75_60$location <- 'smartepicenter'
param_summary_S25_R75_60$detection <- 0.25
param_summary_S25_R75_60$eradication <- 0.75
param_summary_S25_R75_60$budget <- 60
...
param_summary_S25_R75_60b$location <- 'smartepicenter'
param_summary_S25_R75_60b$detection <- 0.25
param_summary_S25_R75_60b$eradication <- 0.75
param_summary_S25_R75_60b$budget <- 60
...
param_summary_S5_R5_60$location <- 'smartepicenter'
param_summary_S5_R5_60$detection <- 0.5
param_summary_S5_R5_60$eradication <- 0.5
param_summary_S5_R5_60$budget <- 60
...
param_summary_S5_R5_60b$location <- 'smartepicenter'
param_summary_S5_R5_60b$detection <- 0.5
param_summary_S5_R5_60b$eradication <- 0.5
param_summary_S5_R5_60b$budget <- 60
...
param_summary_S5_R75_60$location <- 'smartepicenter'
param_summary_S5_R75_60$detection <- 0.5
param_summary_S5_R75_60$eradication <- 0.75
param_summary_S5_R75_60$budget <- 60
...
param_summary_S5_R75_60b$location <- 'smartepicenter'
param_summary_S5_R75_60b$detection <- 0.5
param_summary_S5_R75_60b$eradication <- 0.75
param_summary_S5_R75_60b$budget <- 60
...
param_summary_S75_R5_60$location <- 'smartepicenter'
param_summary_S75_R5_60$detection <- 0.75
param_summary_S75_R5_60$eradication <- 0.5
param_summary_S75_R5_60$budget <- 60
...
param_summary_S75_R5_60b$location <- 'smartepicenter'
param_summary_S75_R5_60b$detection <- 0.75
param_summary_S75_R5_60b$eradication <- 0.5
param_summary_S75_R5_60b$budget <- 60
...
param_summary_S75_R75_60$location <- 'smartepicenter'
param_summary_S75_R75_60$detection <- 0.75
param_summary_S75_R75_60$eradication <- 0.75
param_summary_S75_R75_60$budget <- 60
...
param_summary_S75_R75_60b$location <- 'smartepicenter'
param_summary_S75_R75_60b$detection <- 0.75
param_summary_S75_R75_60b$eradication <- 0.75
param_summary_S75_R75_60b$budget <- 60
...
param_summary_smartepicenter <- rbind(param_summary_20, param_summary_40, param_summary_60)

param_summary <- rbind(param_summary_hstatebins, param_summary_linear,param_summary_smartepicenter)
...
#### NO REMOVAL ####
ncpath <- 'D:\\Chapter3\\results-space2\\noremoval'
...
for(i in 1:length(suppression_alls_shift$location)){
  if(suppression_alls_shift$location[i] == 'smartepicenter'){
