...
state_truth_hstatebins <- rbind(state_truth_20, state_truth_40)
...
state_truth_linear <- rbind(state_truth_20, state_truth_40)
...
state_truth_epicenter <- rbind(state_truth_20, state_truth_40)
...
#-- Combine Bias --#
bias_state <- rbind(bias_state_20, bias_state_40)
...
#-- Combine bias --#
bias_params <- rbind(bias_param_20, bias_param_20)
...
sites_hsd <- rbind(sites_20, sites_40 )
...
sites_linear <- rbind(sites_20, sites_40 )
...
sites_epicenter <- rbind(sites_20, sites_40)
...
dist_hsd <- rbind(dist_20, dist_40)
...
dist_linear <- rbind(dist_20, dist_40)
...
dist_epicenter <- rbind(dist_20, dist_40)
