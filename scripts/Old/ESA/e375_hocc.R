...
#### Path Name ####
path <- here::here("results", "ESA", "e375_hocc")
res <- c('results/ESA/e375_hocc') 
...
file_name = paste(path, 'States_e375_hocc.csv',sep = '/')
...
file_name = paste(path, 'Mean.States_e375_hocc.csv',sep = '/')
...
file_name = paste(path, 'y.obs_e375_hocc.csv',sep = '/')
write.csv(y.obs.df,file_name)


rem.site.df <- y.obs.df %>% filter(observed.state == 1)
file_name = paste(path, 'rem.site_e375_hocc.csv',sep = '/')
...
file_name = paste(path, 'sites.visit_e375_hocc.csv',sep = '/')
...
file_name = paste(path, 'States.est_e375_hocc.csv',sep = '/')
...
file_name = paste(path, 'Mean.States.est_e375_hocc.csv',sep = '/')
...
file_name = paste(path, 'logeffort_e375_hocc.csv',sep = '/')
...
file_name = paste(path, 'psis.est_e375_hocc.csv',sep = '/')
...
file_name = paste(path, 'psi0s.est.est_e375_hocc.csv',sep = '/')
...
file_name = paste(path, 'psi1s.est.est_e375_hocc.csv',sep = '/')
...
file_name = paste(path, 'psi2s.est.est_e375_hocc.csv',sep = '/')
...
file_name = paste(path, 'psi3s.est.est_e375_hocc.csv',sep = '/')
...
file_name = paste(path, 'a0s.est.est_e375_hocc.csv',sep = '/')
...
file_name = paste(path, 'a1s.est.est_e375_hocc.csv',sep = '/')
write.csv(a1s.est.df,file_name)

###### rhat vals ######
file_name = paste(path, 'rhat.vals_e375_hocc.csv',sep = '/')
...
file_name = paste(path, 'e375_hocc_time.txt',sep = '/')
