...
#### Path Name ####
path <- here::here("results", "ESA", "eno_hocc")
res <- c('results/ESA/eno_hocc') 
...
for(year in 1:n.years){
  ...
  #1. Keep effort at 0.5

  if(year < n.years){
    for(s in 1:n.sims){

      logsearch.effort[,year+1,s] <- log(0.5)
...
file_name = paste(path, 'States_eno_hocc.csv',sep = '/')
...
file_name = paste(path, 'Mean.States_eno_hocc.csv',sep = '/')
...
file_name = paste(path, 'y.obs_eno_hocc.csv',sep = '/')
write.csv(y.obs.df,file_name)


rem.site.df <- y.obs.df %>% filter(observed.state == 1)
file_name = paste(path, 'rem.site_eno_hocc.csv',sep = '/')
...
file_name = paste(path, 'sites.visit_eno_hocc.csv',sep = '/')
...
file_name = paste(path, 'States.est_eno_hocc.csv',sep = '/')
...
file_name = paste(path, 'Mean.States.est_eno_hocc.csv',sep = '/')
...
file_name = paste(path, 'logeffort_eno_hocc.csv',sep = '/')
...
file_name = paste(path, 'psis.est_eno_hocc.csv',sep = '/')
...
file_name = paste(path, 'psi0s.est.est_eno_hocc.csv',sep = '/')
...
file_name = paste(path, 'psi1s.est.est_eno_hocc.csv',sep = '/')
...
file_name = paste(path, 'psi2s.est.est_eno_hocc.csv',sep = '/')
...
file_name = paste(path, 'psi3s.est.est_eno_hocc.csv',sep = '/')
...
file_name = paste(path, 'a0s.est.est_eno_hocc.csv',sep = '/')
...
file_name = paste(path, 'a1s.est.est_eno_hocc.csv',sep = '/')
write.csv(a1s.est.df,file_name)

###### rhat vals ######
file_name = paste(path, 'rhat.vals_eno_hocc.csv',sep = '/')
...
file_name = paste(path, 'eno_hocc_time.txt',sep = '/')
