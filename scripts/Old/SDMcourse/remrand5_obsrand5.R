...
#Remove at random 5 locations but collect monitoring data
#at next 5 random locations
...
n.obs <- 5 #we collect detection/non detection at 3 locations
n.sims <- 5
...
#### Path Name ####
path <- here::here("Final_Project", "results", "remrand5_obsrand5")
res <- c('Final_Project/results/remrand5_obsrand5') #subset of path for plot save
...
file_name = paste(path, 'rrand5_orand5_gamma0est.csv',sep = '/')
...
file_name = paste(path, 'rrand5_orand5_gamma1est.csv',sep = '/')
...
file_name = paste(path, 'rrand5_orand5_epsest.csv',sep = '/')
...
file_name = paste(path, 'rrand5_orand5_pest.csv',sep = '/')
...
file_name = paste(path, 'rrand5_orand5_segrem.csv',sep = '/')
