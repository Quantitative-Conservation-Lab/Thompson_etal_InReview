...
#### Path Name ####
path <- here::here("results", "ESA", "e625_random")
res <- c('results/ESA/e625_random') 
...
for(year in 1:n.years){
  ...
  ###### 3b. Make decision  #####
  #Effort level: remove at effort where detection probability is estimated to be 0.625
  #Removal locations: rank sites by occupancy probability, remove until resource is expelled
  
  #1. find effort where detection probability = 0.625
  
  det.p <- log(0.625/(1-0.625))
  ...
  if(year < n.years){
    ...
    #2. find locations
    for(s in 1:n.sims){
      sites.rem[,year+1,s] <- sample(seq(1,n.sites), n.sites, replace = F)
    }
...
file_name = paste(path, 'States_e625_random.csv',sep = '/')
...
file_name = paste(path, 'Mean.States_e625_random.csv',sep = '/')
...
file_name = paste(path, 'y.obs_e625_random.csv',sep = '/')
write.csv(y.obs.df,file_name)


rem.site.df <- y.obs.df %>% filter(observed.state == 1)
file_name = paste(path, 'rem.site_e625_random.csv',sep = '/')
...
file_name = paste(path, 'sites.visit_e625_random.csv',sep = '/')
...
file_name = paste(path, 'States.est_e625_random.csv',sep = '/')
...
file_name = paste(path, 'Mean.States.est_e625_random.csv',sep = '/')
...
file_name = paste(path, 'logeffort_e625_random.csv',sep = '/')
...
file_name = paste(path, 'psis.est_e625_random.csv',sep = '/')
...
file_name = paste(path, 'psi0s.est.est_e625_random.csv',sep = '/')
...
file_name = paste(path, 'psi1s.est.est_e625_random.csv',sep = '/')
...
file_name = paste(path, 'psi2s.est.est_e625_random.csv',sep = '/')
...
file_name = paste(path, 'psi3s.est.est_e625_random.csv',sep = '/')
...
file_name = paste(path, 'a0s.est.est_e625_random.csv',sep = '/')
...
file_name = paste(path, 'a1s.est.est_e625_random.csv',sep = '/')
write.csv(a1s.est.df,file_name)

###### rhat vals ######
file_name = paste(path, 'rhat.vals_e625_random.csv',sep = '/')
...
file_name = paste(path, 'e625_random_time.txt',sep = '/')
