...
pM.l[2] <- invlogit(p.l0s[2] + p.l1s[2]*logsearch.effort + alpha.ls[2])
pM.l[3] <- invlogit(p.l0s[1] + p.l1s[1]*logsearch.effort + alpha.ls[1])

pM.h[1] <- invlogit(p.h0s[3] + p.h1s[3]*logsearch.effort + alpha.hs[3])
pM.h[2] <- invlogit(p.h0s[2] + p.h1s[2]*logsearch.effort + alpha.hs[2]) #high state detection probability (base detection + effect of effort)
pM.h[3] <- invlogit(p.h0s[1] + p.h1s[1]*logsearch.effort + alpha.hs[1])
