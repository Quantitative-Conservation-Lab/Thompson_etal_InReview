...
B1.eps.l ~ dnorm(B1.eps.l.mean, B1.eps.l.tau) #effect of eradication 
...
B1.eps.h ~ dnorm(B1.eps.h.mean, B1.eps.h.tau) #effect of eradication 
...
B1.phi.h ~ dnorm(B1.phi.h.mean, B1.phi.h.tau) #effect of removal on transition
...
B1.p.l ~ dnorm(B1.p.l.mean, B1.p.l.tau) #effect of effort 
...
B1.p.h ~ dnorm(B1.p.h.mean, B1.p.h.tau) #effect of effort 
...
logit(pM.l) <- B0.p.l + B1.p.l*logeffort + alpha.l #detection low state
logit(pM.h) <- B0.p.h + B1.p.h*logeffort + alpha.h #detection high state
