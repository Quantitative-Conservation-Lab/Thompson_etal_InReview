...
##### Path to save data ####
path <- 'E:\\Chapter3\\results-datboth-space2\\budget20\\hstatebins_S5_R75_cert_b'
res <- 'E:/Chapter3/densplots/results-datboth-space2/budget20/hstatebins_S5_R75_cert_b'
...
for(s in 1:n.sims){
  pD.l[s] <- 1 #invlogit(B0.pl.D[s]) # + B1.pl.D[s]*logeffort.D)
  pD.h[s] <- 1 #invlogit(B0.ph.D[s]) # + B1.ph.D[s]logeffort.D)
