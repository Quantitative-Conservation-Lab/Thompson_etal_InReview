...
##### Path to save data ####
path <- 'E:\\Chapter3\\results-datboth-space2\\budget40\\epicenter_S5_R75'
res <- 'E:/Chapter3/densplots/results-datboth-space2/budget40/epicenter_S5_R75'

n.resource <- 40 #total hours per week

#year 3 data path
y3 <- 'E:\\Chapter3\\results-space2\\first3yrs_40'
