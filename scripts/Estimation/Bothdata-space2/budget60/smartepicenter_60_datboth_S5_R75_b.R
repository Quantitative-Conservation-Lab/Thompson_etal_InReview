...
##### Path to save data ####
path <- here::here("results-datboth-space2", "budget60", "smartepicenter_S5_R75_b")
res <- here::here("results-datboth-space2", "budget60", "smartepicenter_S5_R75_b", "densplots")
n.resource <- 60 #total hours per week

#year 3 data path
y3 <- here::here("results", "space2", "first3yrs_60_b") 
