...
##### Path to save data ####
path <- here::here("results", "smartepi", "space2", "S75_R75_60_b")
res <- here::here("results", "smartepi", "space2", "S75_R75_60_b", "densplots")
...
for(year in 1:n.years){
  ...
  ###### 2b. JAGS data ######
   ...
   for(s in 1:n.sims){
    for(w in 1:n.weeks){
      hours.dat[1,,w,year,s] <- exp(logsearch.effort[s])
      hours.dat[2,,w,year,s] <- removal.effort[s]
    }
  }
