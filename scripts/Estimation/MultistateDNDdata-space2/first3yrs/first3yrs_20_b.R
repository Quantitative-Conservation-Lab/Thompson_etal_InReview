...
#### Path to save data ####
#### Change name ####
path <- 'E:\\Chapter3\\results-space2\\first3yrs_20_b'

res <- 'E:/Chapter3/densplots-space2/first3yrs_20_b'
#------------------------------------------------------------------------------#
#### Management Strategy ####
...
write.table(site.visit,file_name)
...
file_name = paste(path, 'y_dat.csv',sep = '/')
