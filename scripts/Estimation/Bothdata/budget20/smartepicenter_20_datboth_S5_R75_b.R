...
##### Path to save data ####
path <- here::here("results-datboth", "budget20", "smartepicenter_S5_R75_b")
res <- here::here("results-datboth", "budget20", "smartepicenter_S5_R75_b", "densplots")

n.resource <- 20 #total hours per week

#year 3 data path
y3 <- here::here("results", "first3yrs_20_b") 
