...
##### Path to save data ####
path <- here::here("results-datboth", "budget60", "smartepicenter_S5_R75")
res <- here::here("results-datboth", "budget60", "smartepicenter_S5_R75", "densplots")

n.resource <- 60 #total hours per week

#year 3 data path
y3 <- here::here("results", "first3yrs_60") 
