...
##### Path to save data ####
path <- 'E:\\Chapter3\\results\\p_eps_hrs\\space2'
...
search.effort.dat$sim <- as.numeric(search.effort.dat$sim)+100
...
removal.effort.dat$sim <- as.numeric(removal.effort.dat$sim) +100
...
search.effort.dat$space <- 2

file_name = paste(path, 'hrsdat_2.csv',sep = '/')
