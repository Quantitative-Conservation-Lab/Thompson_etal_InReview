...
#### Path Name ####
path <- here::here("results", "Multistate", "e1hr_rand_datD")
res <- c('results/Multistate/e1hr_rand_datD') 
...
for(year in 1:n.years){
  ...
  if(year < n.years){
    ...
    #Removal locations: rank sites randomly
     for(s in 1:n.sims){
      sites.rem[,1,year+1,s] <- sample(seq(1,n.sites), n.sites, replace = F)
    }
...
file_name = paste(path, 'e1_rand_time.txt',sep = '/')
...
file_name = paste(path, 'States_e1_rand.csv',sep = '/')
...
file_name = paste(path, 'Mean.States_e1_rand.csv',sep = '/')
...
file_name = paste(path, 'y.obs_e1_rand.csv',sep = '/')
write.csv(yD.df,file_name)


rem.site.df <- yD.df %>% filter(observed.state > 1)
file_name = paste(path, 'rem.site_e1_rand.csv',sep = '/')
...
file_name = paste(path, 'sites.visit_e1_rand.csv',sep = '/')
...
file_name = paste(path, 'States.est_e1_rand.csv',sep = '/')
...
file_name = paste(path, 'Mean.States.est_e1_rand.csv',sep = '/')
...
file_name = paste(path, 'eps.l0.est_e1_rand.csv',sep = '/')
...
file_name = paste(path, 'eps.l1.est_e1_rand.csv',sep = '/')
...
file_name = paste(path, 'eps.h0.est_e1_rand.csv',sep = '/')
...
file_name = paste(path, 'eps.h1.est_e1_rand.csv',sep = '/')
...
file_name = paste(path, 'gamma.0.est_e1_rand.csv',sep = '/')
...
file_name = paste(path, 'gamma.1.est_e1_rand.csv',sep = '/')
...
file_name = paste(path, 'gamma.2.est_e1_rand.csv',sep = '/')
...
file_name = paste(path, 'phi.lh.est_e1_rand.csv',sep = '/')
...
file_name = paste(path, 'phi.hh.est_e1_rand.csv',sep = '/')
...
file_name = paste(path, 'p.l0.est_e1_rand.csv',sep = '/')
...
file_name = paste(path, 'p.l1.est_e1_rand.csv',sep = '/')
...
file_name = paste(path, 'p.h0.est_e1_rand.csv',sep = '/')
...
file_name = paste(path, 'p.h1.est_e1_rand.csv',sep = '/')
write.csv(p.h1.s.df,file_name)

##### rhat vals ######
file_name = paste(path, 'rhat.vals_e1_rand.csv',sep = '/')
