...
path <- 'E:\\Chapter3\\results-datboth\\budget40\\hstatebins_S5_R75_40'
file_name = paste(path, 'states_truth.csv',sep = '/')
...
path <- 'E:\\Chapter3\\results-datboth\\budget40\\hstatebins_S5_R75_40_b'
file_name = paste(path, 'states_truth.csv',sep = '/')
...
path <- 'E:\\Chapter3\\results-datboth\\budget40\\epicenter_S5_R75_40'
file_name = paste(path, 'states_truth.csv',sep = '/')
...
path <- 'E:\\Chapter3\\results-datboth\\budget40\\epicenter_S5_R75_40_b'
file_name = paste(path, 'states_truth.csv',sep = '/')
